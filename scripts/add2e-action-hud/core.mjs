...
import { abilityRows, armorClass, effectRows, hp, hpMax, saveRows, thaco } from "./effects.mjs";
...
function hudHtml(actor, token = null) {
  ...
  const equipmentContent = `${equipmentRows(actor)}${objectPowerContent}`;
