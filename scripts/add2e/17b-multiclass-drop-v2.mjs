// ADD2E — Multiclassage : drop classe/race — implémentation V2
// Version : 2026-06-16-multiclass-drop-texteditor-v2
...
export function installDropWrapper() {
  ...
  if (SheetClass.prototype._add2eMulticlassWrapped === "split-v1-texteditor-v2") return true;
  ...
  SheetClass.prototype._add2eMulticlassWrapped = "split-v1-texteditor-v2";
  return true;
}
