...
const ADD2E_ARMORER_STYLE = `
  ...
  .add2e-armorer-item{min-width:280px}.add2e-armorer-item-wrap{display:flex;align-items:center;gap:8px;min-width:0}.add2e-armorer-item img{width:34px!important;height:34px!important;min-width:34px!important;max-width:34px!important;max-height:34px!important;object-fit:contain!important;border:1px solid #8f6b37;border-radius:6px;background:#f8edc7}.add2e-armorer-item span{font-weight:950;white-space:normal;line-height:1.2}
