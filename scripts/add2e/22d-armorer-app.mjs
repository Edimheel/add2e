...
const ADD2E_ARMORER_APP_VERSION = "2026-07-01-armorer-app-v8-vendor-density-scroll";
...
const ADD2E_ARMORER_STYLE = `
  ...
  .add2e-armorer-search{flex:0 0 auto;padding:10px 14px;border-bottom:1px solid #d9bf73;background:#fff1bf}.add2e-armorer-search-input{width:100%;min-height:30px;padding:5px 9px;border:1px solid #b98b2d;border-radius:8px;background:#fffaf0;color:#2f250c;font-weight:700}
  .add2e-armorer-table-wrap{flex:1 1 auto;min-height:0;overflow-y:auto!important;overflow-x:hidden;padding:12px 14px 16px;scrollbar-gutter:stable}.add2e-armorer-table{width:100%;height:auto!important;border-collapse:collapse;table-layout:auto;background:rgba(255,252,242,.94);border:1px solid #d9bf73;color:#2f250c}.add2e-armorer-table thead{display:table-header-group!important;height:auto!important}.add2e-armorer-table tbody{display:table-row-group!important;height:auto!important;vertical-align:top}.add2e-armorer-table tr{display:table-row!important;height:auto!important;min-height:0!important}.add2e-armorer-table th{position:sticky;top:0;z-index:2;height:auto!important;background:#e8d08f;color:#2f250c;border-bottom:1px solid #b98b2d;padding:7px 8px;text-align:left;font-weight:950;line-height:1.2}.add2e-armorer-table td{height:auto!important;padding:5px 7px;border-bottom:1px solid #e0c982;vertical-align:middle;color:#2f250c;font-weight:750;line-height:1.2}.add2e-armorer-table tbody tr:nth-child(even){background:rgba(242,222,169,.35)}.add2e-armorer-table tbody tr:hover{background:rgba(255,231,168,.7)}
...
class Add2eArmorerApp extends foundry.applications.api.ApplicationV2 {
  static DEFAULT_OPTIONS = {
    ...
    position: { width: 1170, height: 720 }
  };
