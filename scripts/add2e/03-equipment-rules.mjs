...
try { globalThis.add2eNormalizeEquipTag = add2eNormalizeEquipTag; } catch (_e) {}
try { globalThis.add2eToEquipArray = add2eToEquipArray; } catch (_e) {}
...
try { globalThis.add2eGetActorClassSystem = add2eGetActorClassSystem; } catch (_e) {}
try { globalThis.add2eGetItemEquipTags = add2eGetItemEquipTags; } catch (_e) {}
...
try { globalThis.add2eCheckEquipmentAllowedForClass = add2eCheckEquipmentAllowedForClass; } catch (_e) {}
