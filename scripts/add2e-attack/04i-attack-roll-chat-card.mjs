...
export function add2eBuildAttackChatCard(ctx) {
  ...
  const statusColor = hit ? "#27ae60" : "#b7473f";
  const statusText = hit ? "TOUCHÉ !" : "Raté.";
  const statusIcon = hit ? "fa-check" : "fa-times";
  ...
  return [
    ...
    `<div style="white-space:nowrap;border:1px solid rgba(255,255,255,.45);background:${statusColor};color:#fff;border-radius:999px;padding:4px 9px;font-weight:950;font-size:.86rem;">${statusText}</div>`,
    `</div>`,
    ...
    assassination,
    `<details style="margin-top:8px;border:1px solid #c6a85b;border-radius:9px;background:#fffdf6;overflow:hidden;" open><summary style="cursor:pointer;background:#ead7a4;color:#3f2d0e;padding:7px 9px;font-weight:950;"><i class="fas fa-list-check"></i> Détails du jet</summary><div style="padding:8px;display:grid;gap:7px;">`,
    `<details style="border:1px solid #d9c894;border-radius:8px;background:#fff;overflow:hidden;" open><summary style="cursor:pointer;padding:6px 8px;background:#f4ead1;font-weight:950;color:#5a3c11;"><i class="fas fa-bullseye"></i> Toucher</summary><div style="padding:8px;line-height:1.55;color:#2f2a20;">${touchLines}</div></details>`,
    `<details style="border:1px solid #d9c894;border-radius:8px;background:#fff;overflow:hidden;" ${hit ? "open" : ""}><summary style="cursor:pointer;padding:6px 8px;background:#f4ead1;font-weight:950;color:#5a3c11;"><i class="fas fa-burst"></i> Dommages</summary><div style="padding:8px;line-height:1.55;color:#2f2a20;">${damageLines}</div></details>`,
    `</div></details>`,
    `</div></div>`
  ].filter(Boolean).join("");
}
