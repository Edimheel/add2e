  ...
  return `
        ...
        <form class="add2e-attack-form">
          ...
          <div style="display:grid;grid-template-columns:minmax(0,1fr) 220px;gap:4px;align-items:start;margin-bottom:0;">
            <div style="min-width:0;display:flex;align-items:center;gap:5px;margin-left:28px;padding:4px 5px;border:1px solid #d5b15a;border-radius:7px;background:#fffdf4;">
