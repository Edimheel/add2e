// ADD2E — onUse Clerc niveaux 5-7 : Marche des vents
...
const ADD2E_SORT_CONFIG = {
  "name": "Marche des vents",
  "slug": "marche_des_vents",
  "level": 7,
  "script_type": "wind_walk",
  "description": "Marche des vents produit un déplacement magique ou un passage surnaturel. La destination, les limites de transport, les risques, les restrictions de plan et les protections éventuelles sont fixés par les règles du sort et par le MD selon la scène.",
