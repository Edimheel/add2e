// ADD2E — onUse Illusionniste niveau 5 : Création majeure
...
const ADD2E_SORT_CONFIG = {
  "name": "Création majeure",
  "slug": "creation_majeure",
  "level": 5,
  "classe": "Illusionniste",
  "script_type": "note",
  "description": "Création majeure produit un effet utilitaire d’illusionniste. Le script conserve la structure ADD2E, affiche un message de chat cohérent et crée un suivi minimal si nécessaire.",
  "effect_rounds": 0,
  "effectTags": [
    "creation:majeure"
  ],
