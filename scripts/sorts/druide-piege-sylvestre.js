// ADD2E — onUse Druide niveau 3 : Piège sylvestre
...
const ADD2E_SORT_CONFIG = {
  "name": "Piège sylvestre",
  "slug": "piege_sylvestre",
  "level": 3,
  "classe": "Druide",
  "script_type": "note",
  "description": "Piège sylvestre modifie le terrain, les plantes, les eaux, la pierre, le bois, le métal ou la météo. L’effet est principalement tactique et scénographique : le MD fixe les dimensions exactes, la praticabilité, les dégâts éventuels et les conséquences durables.",
  "effect_rounds": 0,
  "effectTags": [
    "piege:sylvestre",
    "nature"
