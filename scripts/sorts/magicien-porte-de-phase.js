// ADD2E — onUse Magicien : Porte de phase
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 7,
  "kind": "movement",
  "description": "Porte de phase permet un déplacement, un passage, une lévitation, un vol, une téléportation ou une transition magique. Le MD valide les limites et la destination.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
