// ADD2E — onUse Magicien : Lumières dansantes
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 1,
  "kind": "utility",
  "description": "Lumières dansantes produit un effet utilitaire de magicien. Le script conserve la structure ADD2E, affiche un message de chat et crée un suivi si nécessaire.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
