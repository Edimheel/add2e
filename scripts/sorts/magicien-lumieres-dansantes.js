...
return await (async () => {
  const VERSION = "2026-08-13-wizard-dancing-lights-v5";
  ...
  if (!isObjectPower && !listKeys.includes("magicien")) {
    ui.notifications?.error?.("Lumières dansantes : cet Item n’appartient pas à la liste Magicien.");
    return false;
  }
  ...
  const card = {
    ...
    source: {
      ...
      type: isObjectPower ? "Pouvoir d’objet magique" : "Sort de magicien",
