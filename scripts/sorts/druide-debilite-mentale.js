// ADD2E — onUse Druide niveau 6 : Débilité mentale
...
const ADD2E_SORT_CONFIG = {
  "name": "Débilité mentale",
  "slug": "debilite_mentale",
  "level": 6,
  "classe": "Druide",
  "script_type": "simple_effect",
  "description": "Débilité mentale applique, retire ou transforme un état important : paralysie, poison, maladie, confusion, transformation ou autre condition. Le script crée ou retire les effets actifs reconnus, puis le MD tranche les cas particuliers.",
  "effect_rounds": "long",
  "effectTags": [
    "etat:debilite_mentale",
    "mental"
  ],
  "modes": [
    {
      "id": "normal",
      "label": "Débilité mentale"
    }
  ],
  "dice": null
};
