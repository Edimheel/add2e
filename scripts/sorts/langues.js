// ADD2E — onUse Clerc niveau 4 : Langues
...
const ADD2E_SORT_CONFIG = {
  ...
  "description": "Permet à la créature touchée de comprendre et parler les langues intelligibles entendues pendant la durée. Le sort ne confère pas de connaissances cachées, de lecture automatique des écritures codées ou de compréhension des messages dépourvus de langage. La forme inverse peut brouiller ou empêcher la compréhension linguistique.",
  "effect_rounds": 10,
  "effectTags": [
    "langage",
    "comprehension:langues"
  ],
  "modes": [
    {
      "id": "normal",
