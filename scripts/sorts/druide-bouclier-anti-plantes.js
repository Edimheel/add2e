// ADD2E — onUse Druide niveau 5 : Bouclier anti-plantes
...
const ADD2E_SORT_CONFIG = {
  "name": "Bouclier anti-plantes",
  "slug": "bouclier_anti_plantes",
  "level": 5,
  "classe": "Druide",
  "script_type": "simple_effect",
  "description": "Bouclier anti-plantes place une protection naturelle ou druidique sur une créature, une zone ou le lanceur. L’effet doit être pris en compte lors des attaques, jets de sauvegarde, déplacements ou interactions avec les créatures et éléments concernés. Les limites exactes dépendent de la scène et de la règle du sort.",
  "effect_rounds": "10*level",
  "effectTags": [
    "bouclier:anti_plantes",
    "protection:plantes"
  ],
  "modes": [
    {
      "id": "normal",
      "label": "Bouclier anti-plantes"
    }
  ],
  "dice": null
};
