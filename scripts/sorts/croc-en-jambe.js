// ADD2E — onUse Clerc niveau 2 : Croc-en-Jambe
...
const ADD2E_SORT_CONFIG = {
  "name": "Croc-en-Jambe",
  "slug": "croc_en_jambe",
  "script_type": "ward_effect",
  "description": "Le clerc enchante un objet, une corde, une liane, une racine, un bâton ou un obstacle similaire pour le faire agir comme un piège magique. Une créature qui traverse ou touche la zone affectée peut trébucher, tomber ou être gênée selon la situation et le jet de protection prévu. Le sort sert surtout à contrôler un passage, ralentir une poursuite ou créer une défense discrète. La nature exacte de l’obstacle, sa visibilité, la vitesse de déplacement et la taille de la victime sont arbitrées par le MD.",
