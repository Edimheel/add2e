// ADD2E — onUse Magicien : Escalade d’araignée
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "escalade_d_araignee",
  "level": 1,
  "kind": "utility",
  "description": "Escalade d’araignée produit un effet utilitaire de magicien. Le script conserve la structure ADD2E, affiche un message de chat et crée un suivi si nécessaire.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Escalade d’araignée"
    }
  ]
};
