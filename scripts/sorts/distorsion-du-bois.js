// ADD2E — onUse Clerc niveau 2 : Distorsion du Bois
...
const ADD2E_SORT_CONFIG = {
  "name": "Distorsion du Bois",
  "slug": "distorsion_du_bois",
  "script_type": "object_effect",
  "description": "Le clerc déforme le bois : planches, manches, portes, armes, traits, hampes ou objets similaires peuvent se tordre, gonfler, vriller ou devenir inutilisables. Le sort affecte une quantité de bois dépendant du niveau et de la taille de l’objet. Les objets magiques, très massifs ou protégés peuvent résister ou bénéficier d’un traitement spécial selon le MD. La forme inversée peut redresser ou restaurer un bois déformé dans les limites du sort.",
  "effect_rounds": 0,
  "effectTags": [
    "alteration:bois",
    "objet:bois",
    "etat:distorsion_bois"
  ],
  "modes": [
    {
      "id": "normal",
