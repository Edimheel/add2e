// ADD2E — onUse Magicien : Image miroir.
// Compatible Foundry V13/V14/V15.
// La mécanique est exclusivement portée par image-miroir.js.

const response = await fetch("systems/add2e/scripts/sorts/image-miroir.js", { cache: "no-store" });
if (!response.ok) {
  throw new Error(`Image miroir : onUse principal introuvable (${response.status}).`);
}
