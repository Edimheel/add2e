// ADD2E — onUse Magicien : Main d’interposition de Bigby
// Version : 2026-05-05-magicien-n1-9-v2
// Retour attendu : true = sort consommé, false = sort non consommé.

const ADD2E_SORT_CONFIG = {
  "name": "Main d’interposition de Bigby",
  "slug": "main_d_interposition_de_bigby",
  "level": 5,
  "kind": "utility",
  "description": "Main d’interposition de Bigby produit un effet utilitaire de magicien. Le script conserve la structure ADD2E, affiche un message de chat et crée un suivi si nécessaire.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Main d’interposition de Bigby"
    }
  ]
};
