// ADD2E — onUse Illusionniste niveau 3 : Écriture illusoire
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "ecriture_illusoire",
  "level": 3,
  "classe": "Illusionniste",
  "script_type": "note",
  "description": "Écriture illusoire crée, modifie ou maintient une illusion. La perception des créatures, les interactions physiques, les sauvegardes éventuelles et les limites de vraisemblance sont déterminées par les règles du sort et par le MD.",
  "effect_rounds": 0,
  "effectTags": [
    "ecriture:illusoire",
    "illusion:texte"
