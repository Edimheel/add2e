// ADD2E — onUse Magicien : Piège de Léomund
// Version : 2026-05-05-magicien-n1-9-v2
// Retour attendu : true = sort consommé, false = sort non consommé.

const ADD2E_SORT_CONFIG = {
  "name": "Piège de Léomund",
  "slug": "piege_de_leomund",
  "level": 2,
  "kind": "terrain",
  "description": "Piège de Léomund modifie une zone, un terrain, une matière, un mur, une porte ou un environnement. Les dimensions et conséquences exactes sont fixées par le MD.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Piège de Léomund"
    }
  ]
};
