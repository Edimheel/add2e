// ADD2E — onUse Druide niveau 4 : Contrôle de la température sur 3 m
...
const ADD2E_SORT_CONFIG = {
  "name": "Contrôle de la température sur 3 m",
  "slug": "controle_de_la_temperature_sur_3_m",
  "level": 4,
  "classe": "Druide",
  "script_type": "simple_effect",
  "description": "Contrôle de la température sur 3 m place une protection naturelle ou druidique sur une créature, une zone ou le lanceur. L’effet doit être pris en compte lors des attaques, jets de sauvegarde, déplacements ou interactions avec les créatures et éléments concernés. Les limites exactes dépendent de la scène et de la règle du sort.",
