// ADD2E — onUse Magicien : Eau aérée
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 5,
  "kind": "terrain",
  "description": "Eau aérée modifie une zone, un terrain, une matière, un mur, une porte ou un environnement. Les dimensions et conséquences exactes sont fixées par le MD.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
