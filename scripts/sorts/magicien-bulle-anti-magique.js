// ADD2E — onUse Magicien : Bulle anti-magique
// Version : 2026-05-05-magicien-n1-9-v2
// Retour attendu : true = sort consommé, false = sort non consommé.

const ADD2E_SORT_CONFIG = {
  "name": "Bulle anti-magique",
  "slug": "bulle_anti_magique",
  "level": 6,
  "kind": "protection",
  "description": "Bulle anti-magique applique une défense, une barrière ou une protection magique. Le script crée un effet actif de suivi afin que le sort soit visible et exploitable dans Foundry.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Bulle anti-magique"
    }
  ]
};
