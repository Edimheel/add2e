// ADD2E — onUse Magicien : Runes explosives
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "runes_explosives",
  "level": 3,
  "kind": "damage",
  "description": "Runes explosives produit un effet offensif de magicien. Les dégâts, jets de sauvegarde, résistances, immunités et effets secondaires doivent être appliqués selon la règle du sort et l’arbitrage du MD.",
  "dice": "6d4+6",
  "modes": [
    {
      "id": "normal",
      "label": "Runes explosives"
    }
  ]
};
