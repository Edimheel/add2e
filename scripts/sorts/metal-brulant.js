// ADD2E — onUse Clerc niveau 2 : Métal Brûlant
...
const ADD2E_SORT_CONFIG = {
  "name": "Métal Brûlant",
  "slug": "metal_brulant",
  "script_type": "heat_metal",
  "description": "Le clerc chauffe progressivement un métal porté, tenu ou touché par une cible. L’effet dure 7 rounds et devient dangereux au fil du temps : le métal passe de chaud à brûlant, puis refroidit ensuite selon la progression du sort. Les créatures portant une armure métallique, tenant une arme ou un objet de métal peuvent subir des dégâts, lâcher l’objet ou tenter d’agir pour s’en débarrasser. La forme inversée, métal gelé, applique un froid intense selon le même principe. Les résistances, immunités et protections élémentaires s’appliquent.",
  "effect_rounds": 7,
  "effectTags": [
    "degat:feu",
    "objet:metal",
  ...
  "inverseLabel": "Métal Gelé",
  "inverseTags": [
    "reversible:metal_gele",
    "etat:metal_gele"
  ]
};
