// ADD2E — onUse Magicien : Lithomorphose
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 5,
  "kind": "utility",
  "description": "Lithomorphose produit un effet utilitaire de magicien. Le script conserve la structure ADD2E, affiche un message de chat et crée un suivi si nécessaire.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
