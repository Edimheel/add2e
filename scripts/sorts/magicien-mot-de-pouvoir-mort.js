// ADD2E — onUse Magicien : Mot de pouvoir : « mort »
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "mot_de_pouvoir_mort",
  "level": 9,
  "kind": "damage",
  "description": "Mot de pouvoir : « mort » produit un effet offensif de magicien. Les dégâts, jets de sauvegarde, résistances, immunités et effets secondaires doivent être appliqués selon la règle du sort et l’arbitrage du MD.",
  "dice": "special",
  "modes": [
    {
      "id": "normal",
      "label": "Mot de pouvoir : « mort »"
    }
  ]
};
