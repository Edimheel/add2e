// ADD2E — onUse Magicien : Stase temporelle
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "stase_temporelle",
  "level": 9,
  "kind": "condition",
  "description": "Stase temporelle applique un état ou une transformation : charme, peur, invisibilité, paralysie, rapidité, ralentissement, métamorphose ou effet comparable. Le script pose un effet actif de suivi.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Stase temporelle"
    }
  ]
};
