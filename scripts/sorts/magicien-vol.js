...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 3,
  "kind": "movement",
  "description": "Vol permet un déplacement, un passage, une lévitation, un vol, une téléportation ou une transition magique. Le MD valide les limites et la destination.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
