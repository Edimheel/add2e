// ADD2E — onUse Magicien : Transformation de Tenser
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "transformation_de_tenser",
  "level": 6,
  "kind": "condition",
  "description": "Transformation de Tenser applique un état ou une transformation : charme, peur, invisibilité, paralysie, rapidité, ralentissement, métamorphose ou effet comparable. Le script pose un effet actif de suivi.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Transformation de Tenser"
    }
  ]
};
