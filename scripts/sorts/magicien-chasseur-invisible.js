// ADD2E — onUse Magicien : Chasseur invisible
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "chasseur_invisible",
  "level": 6,
  "kind": "utility",
  "description": "Chasseur invisible produit un effet utilitaire de magicien. Le script conserve la structure ADD2E, affiche un message de chat et crée un suivi si nécessaire.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Chasseur invisible"
    }
  ]
};
