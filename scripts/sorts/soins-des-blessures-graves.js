// ADD2E — onUse Clerc niveau 4 : Soins des Blessures Graves
...
const ADD2E_SORT_CONFIG = {
  "name": "Soins des Blessures Graves",
  "slug": "soins_des_blessures_graves",
  "script_type": "heal_serious",
  "description": "Rend 2d8+1 points de vie à une créature vivante blessée, dans la limite normale de ses points de vie maximum. Le sort n’affecte pas les morts-vivants ni les créatures qui ne peuvent pas recevoir de soins vitaux. La forme inversée, Blessures Graves, inflige 2d8+1 points de dégâts à une créature touchée selon les conditions d’attaque ou de contact imposées par le MD.",
  "effect_rounds": 0,
  "effectTags": [
    "soin:2d8+1",
    "degats_inverse:2d8+1",
    "etat:soin"
  ],
  "modes": [
    {
      "id": "normal",
      "label": "Soins des Blessures Graves"
    },
    {
      "id": "inverse",
