...
console.log("%c[ADD2E][CREATION D EAU] SCRIPT CUSTOM CLERC", "color:#b88924;font-weight:bold;");
...
const __add2eOnUseResult = await (async () => {
  ...
  function add2eClercCard({ caster, sourceItem, mode, nbOutres, litres, maxLitres, itemCreated, itemUpdated }) {
    ...
    return `
      <div class="add2e-spell-card add2e-spell-card-clerc add2e-spell-card-creation-d-eau" style="
        border-radius:12px;
