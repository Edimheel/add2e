// ADD2E — onUse Magicien : Invocation instantanée de Drawmij
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "invocation_instantanee_de_drawmij",
  "level": 7,
  "kind": "summon",
  "description": "Invocation instantanée de Drawmij invoque, appelle ou crée une créature, un serviteur ou une force magique. Le script note l’invocation ; l’acteur correspondant doit être créé ou lié par le MD.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Invocation instantanée de Drawmij"
    }
  ]
};
