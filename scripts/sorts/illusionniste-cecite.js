// ADD2E — onUse Illusionniste niveau 2 : Cécité
...
const ADD2E_SORT_CONFIG = {
  ...
  "description": "Cécité applique un état mental, sensoriel ou magique : confusion, peur, cécité, surdité, paralysie, invisibilité, suggestion ou trouble. Le script crée un effet actif de suivi sur la cible.",
  "effect_rounds": "long",
  "effectTags": [
    "etat:cecite",
    "aveugle"
