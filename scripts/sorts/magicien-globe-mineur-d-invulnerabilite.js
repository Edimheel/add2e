// ADD2E — onUse Magicien : Globe mineur d’invulnérabilité
// Version : 2026-05-05-magicien-n1-9-v2
// Retour attendu : true = sort consommé, false = sort non consommé.

const ADD2E_SORT_CONFIG = {
  "name": "Globe mineur d’invulnérabilité",
  "slug": "globe_mineur_d_invulnerabilite",
  "level": 4,
  "kind": "protection",
  "description": "Globe mineur d’invulnérabilité applique une défense, une barrière ou une protection magique. Le script crée un effet actif de suivi afin que le sort soit visible et exploitable dans Foundry.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Globe mineur d’invulnérabilité"
    }
  ]
};
