// ADD2E — onUse Clerc niveau 3 : Création de Nourriture et d’Eau
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "creation_de_nourriture_et_d_eau",
  "script_type": "create_food_water",
  "description": "Crée une quantité suffisante de nourriture simple et d’eau potable pour nourrir un groupe selon le niveau du clerc. La nourriture est normale, se conserve comme toute ration ordinaire et peut être partagée, stockée ou consommée immédiatement.",
  "effect_rounds": 0,
  "effectTags": [
    "creation:nourriture",
    "creation:eau",
  ...
  "modes": [
    {
      "id": "normal",
      "label": "Création de Nourriture et d’Eau"
    }
  ]
};
