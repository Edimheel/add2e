...
const ADD2E_SORT_CONFIG = {
  "name": "Délivrance de la Malédiction",
  "slug": "delivrance_de_la_malediction",
  "script_type": "remove_curse",
  "description": "Libère une créature ou un objet d’une malédiction active si le sort est assez puissant pour l’effet concerné. L’inverse permet d’infliger une malédiction, dont les détails et le jet de protection sont fixés par le MD.",
  "effect_rounds": 0,
  "effectTags": [
    "retire:malediction",
    "abjuration"
  ...
  "modes": [
    {
      "id": "normal",
      "label": "Délivrance de la Malédiction"
    },
    {
      "id": "inverse",
      "label": "Malédiction"
  ...
  "inverseLabel": "Malédiction",
  "inverseTags": [
    "reversible:malediction",
    "etat:malediction"
  ]
};
