// ADD2E — onUse Magicien : Localisation d’objets
// Version : 2026-05-05-magicien-n1-9-v2
// Retour attendu : true = sort consommé, false = sort non consommé.

const ADD2E_SORT_CONFIG = {
  "name": "Localisation d’objets",
  "slug": "localisation_d_objets",
  "level": 2,
  "kind": "detection",
  "description": "Localisation d’objets donne au magicien une perception, une lecture ou une information magique. Les protections, obstacles et limites exactes restent à résoudre selon la règle du sort.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
