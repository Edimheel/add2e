// ADD2E — onUse Magicien : Moyen mnémonique de Rary
// Version : 2026-05-05-magicien-n1-9-v2
// Retour attendu : true = sort consommé, false = sort non consommé.

const ADD2E_SORT_CONFIG = {
  "name": "Moyen mnémonique de Rary",
  "slug": "moyen_mnemonique_de_rary",
  "level": 4,
  "kind": "utility",
  "description": "Moyen mnémonique de Rary produit un effet utilitaire de magicien. Le script conserve la structure ADD2E, affiche un message de chat et crée un suivi si nécessaire.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Moyen mnémonique de Rary"
    }
  ]
};
