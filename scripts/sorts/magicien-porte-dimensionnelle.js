// ADD2E — onUse Magicien : Porte dimensionnelle
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "porte_dimensionnelle",
  "level": 4,
  "kind": "movement",
  "description": "Porte dimensionnelle permet un déplacement, un passage, une lévitation, un vol, une téléportation ou une transition magique. Le MD valide les limites et la destination.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Porte dimensionnelle"
    }
  ]
};
