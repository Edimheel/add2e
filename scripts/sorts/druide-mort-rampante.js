// ADD2E — onUse Druide niveau 7 : Mort rampante
...
const ADD2E_SORT_CONFIG = {
  ...
  "description": "Mort rampante appelle, invoque ou mobilise une créature, une force naturelle ou un phénomène vivant. Le script note l’invocation ; le MD crée ou lie ensuite les acteurs nécessaires depuis le bestiaire et fixe leur comportement selon la règle du sort.",
  "effect_rounds": 0,
  "effectTags": [
    "mort:rampante",
    "nuee:insectes"
