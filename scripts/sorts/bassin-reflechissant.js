// ADD2E — onUse Clerc niveau 4 : Bassin Réfléchissant
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "bassin_reflechissant",
  "script_type": "divination_note",
  "description": "Le clerc utilise une eau calme comme surface de divination pour observer un lieu, une créature ou une scène liée à ce qu’il recherche. L’efficacité dépend de la connaissance de la cible, de la distance, des protections magiques et de l’arbitrage du MD. Le sort peut révéler des images, mais pas nécessairement les sons ni tout ce qui est dissimulé par une protection magique.",
  "effect_rounds": "level",
  "effectTags": [
    "divination",
    "scrutation",
