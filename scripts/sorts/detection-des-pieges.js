...
const ADD2E_SORT_CONFIG = {
  ...
  "script_type": "detect_traps",
  "description": "Le clerc perçoit la présence de pièges mécaniques ou magiques dans la direction où il regarde. Le sort est directionnel : le lanceur doit se tourner vers la zone à examiner. Les pièges normalement cachés ou magiquement dissimulés peuvent être révélés, mais le sort ne les désamorce pas. Dans le cas d’un piège magique, le clerc a 10 % de chance par niveau de connaître la nature de la magie impliquée, par exemple divination, altération ou évocation.",
  "effect_rounds": 30,
  "effectTags": [
    "detection:pieges",
    "detection:magie_piege",
    "etat:detection_pieges"
  ],
  "modes": [
    {
      "id": "normal",
