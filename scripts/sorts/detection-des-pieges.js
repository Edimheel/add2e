// ADD2E — onUse Clerc niveau 2 : Détection des pièges
// Chemin Foundry déclaré : systems/add2e/scripts/sorts/detection-des-pieges.js
...
const ADD2E_CLERIC_LEVEL2_SPELL = {
  ...
  "slug": "detection_des_pieges",
  "level": 2,
  "school": "Divination",
  "range": "3 pouces",
  "duration": "3 tours",
  "area": "1 pouce de large",
  "components": "V, S",
  "castingTime": "5 segments",
  "save": "aucun",
  "materials": "",
  "description": "Quand un clerc lance ce sort, tous les pièges — normalement ou magiquement cachés — de nature mécanique ou magique lui apparaissent. Ce sort est directionnel et le lanceur de sort doit faire face à la direction désirée afin de déterminer si un piège se trouve dans cette direction. Le sort donne au clerc 10 % de chance par niveau de détecter le type de magie en jeu (divination, altération, etc.) dans le cas d’un piège magique ou caché par magie.",
  "automation": "Aide MJ DialogV2 : rappeler portée, durée et bande de détection. Aucun repérage de scène automatique.",
  "ruleReminders": []
};
