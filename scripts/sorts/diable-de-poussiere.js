// ADD2E — onUse Clerc niveau 2 : Diable de Poussière
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "diable_de_poussiere",
  "script_type": "summon_note",
  "description": "Le clerc conjure un petit tourbillon de poussière et d’air capable de se déplacer, de gêner, de renverser des objets légers, d’éteindre de petites flammes ou de harceler une créature selon les ordres simples donnés. La créature conjurée n’est pas un serviteur intelligent complexe : elle suit des instructions claires dans la limite de sa nature élémentaire. La durée est de 2 rounds par niveau du clerc. Son comportement précis, ses déplacements et ses effets sur l’environnement sont arbitrés par le MD.",
  "effect_rounds": "2*level",
  "effectTags": [
    "conjuration:diable_poussiere",
    "element:air",
    "etat:conjuration"
  ],
  "modes": [
