// ADD2E — onUse Druide niveau 1 : Détection des pièges sylvestres
...
const ADD2E_SORT_CONFIG = {
  "name": "Détection des pièges sylvestres",
  "slug": "detection_des_pieges_sylvestres",
  "level": 1,
  "classe": "Druide",
  "script_type": "detection",
  "description": "Détection des pièges sylvestres permet au druide d’obtenir une perception surnaturelle liée à la nature, à la magie, aux créatures ou au danger recherché. La portée, l’orientation, les obstacles, les protections magiques et la précision de la recherche sont toujours pris en compte par le MD.",
  "effect_rounds": "10",
  "effectTags": [
  ...
  "modes": [
    {
      "id": "normal",
      "label": "Détection des pièges sylvestres"
    }
  ],
  "dice": null
};
