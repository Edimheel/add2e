// ADD2E — onUse Magicien : Mot de pouvoir : « étourdissement »
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "mot_de_pouvoir_etourdissement",
  "level": 7,
  "kind": "utility",
  "description": "Mot de pouvoir : « étourdissement » produit un effet utilitaire de magicien. Le script conserve la structure ADD2E, affiche un message de chat et crée un suivi si nécessaire.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Mot de pouvoir : « étourdissement »"
    }
  ]
};
