// ADD2E — onUse Magicien : Œil magique
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 4,
  "kind": "detection",
  "description": "Œil magique donne au magicien une perception, une lecture ou une information magique. Les protections, obstacles et limites exactes restent à résoudre selon la règle du sort.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
