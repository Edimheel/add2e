// ADD2E — onUse Magicien : Vigiles et sentinelles
// Version : 2026-05-05-magicien-n1-9-v2
// Retour attendu : true = sort consommé, false = sort non consommé.

const ADD2E_SORT_CONFIG = {
  "name": "Vigiles et sentinelles",
  "slug": "vigiles_et_sentinelles",
  "level": 6,
  "kind": "protection",
  "description": "Vigiles et sentinelles applique une défense, une barrière ou une protection magique. Le script crée un effet actif de suivi afin que le sort soit visible et exploitable dans Foundry.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Vigiles et sentinelles"
    }
  ]
};
