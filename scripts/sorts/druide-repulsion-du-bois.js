// ADD2E — onUse Druide niveau 6 : Répulsion du bois
...
const ADD2E_SORT_CONFIG = {
  "name": "Répulsion du bois",
  "slug": "repulsion_du_bois",
  "level": 6,
  "classe": "Druide",
  "script_type": "simple_effect",
  "description": "Répulsion du bois modifie le terrain, les plantes, les eaux, la pierre, le bois, le métal ou la météo. L’effet est principalement tactique et scénographique : le MD fixe les dimensions exactes, la praticabilité, les dégâts éventuels et les conséquences durables.",
  "effect_rounds": "level",
  "effectTags": [
    "repulsion:bois",
    "vegetal"
