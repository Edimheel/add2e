// ADD2E — onUse Illusionniste niveau 3 : Dissipation des illusions
...
const ADD2E_SORT_CONFIG = {
  "name": "Dissipation des illusions",
  "slug": "dissipation_des_illusions",
  "level": 3,
  "classe": "Illusionniste",
  "script_type": "dispel_illusion",
  "description": "Dissipation des illusions applique une protection, une dissipation, un écran ou une défense magique. Le script pose un effet actif avec les tags nécessaires pour que la mécanique ADD2E puisse l’exploiter si elle existe.",
  "effect_rounds": 0,
  "effectTags": [
    "dissipation:illusion"
  ],
  "modes": [
    {
      "id": "normal",
      "label": "Dissipation des illusions"
    }
  ],
  "dice": null
};
