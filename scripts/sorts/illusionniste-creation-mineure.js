// ADD2E — onUse Illusionniste niveau 4 : Création mineure
...
const ADD2E_SORT_CONFIG = {
  "name": "Création mineure",
  "slug": "creation_mineure",
  "level": 4,
  "classe": "Illusionniste",
  "script_type": "note",
  "description": "Création mineure produit un effet utilitaire d’illusionniste. Le script conserve la structure ADD2E, affiche un message de chat cohérent et crée un suivi minimal si nécessaire.",
  "effect_rounds": 0,
  "effectTags": [
    "creation:mineure",
    "matiere:vegetale"
