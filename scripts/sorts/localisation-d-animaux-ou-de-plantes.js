...
const ADD2E_CLERIC_ONUSE_CONFIG = {
  "kind": "detection",
  "durationRounds": "level",
  "targetLabel": "Type recherché",
  "fields": [
    {
      "name": "typeRecherche",
      "label": "Animal ou plante recherché",
      "type": "text",
      "value": "type précis"
    }
  ],
  ...
  "rule": "Permet au clerc de ressentir la direction vers un type précis d’animal ou de plante dans la portée du sort.",
  "name": "Localisation d’Animaux ou de Plantes",
  "slug": "localisation-d-animaux-ou-de-plantes",
  "imgFallback": "systems/add2e/assets/icones/sorts/localisation-d-animaux-ou-de-plantes.webp"
};
...
if (__add2eOnUseResult !== true && __add2eOnUseResult !== false) {
  console.error("[ADD2E][ONUSE][BAD_RETURN_STRICT] Le script onUse doit retourner true ou false.", {
    script: "localisation-d-animaux-ou-de-plantes.js",
