// ADD2E — onUse Illusionniste niveau 7 : Altération de la réalité
...
const ADD2E_SORT_CONFIG = {
  "name": "Altération de la réalité",
  "slug": "alteration_de_la_realite",
  "level": 7,
  "classe": "Illusionniste",
  "script_type": "note",
  "description": "Altération de la réalité donne accès ou simule un ensemble de sorts selon la règle de l’illusionniste. Le choix précis du sort reproduit, sa résolution et ses limites sont validés par le MD.",
  "effect_rounds": 0,
  "effectTags": [
    "alteration:realite",
    "souhait:mineur"
