// ADD2E — onUse Magicien : Flèche de feu
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 3,
  "kind": "damage",
  "description": "Flèche de feu produit un effet offensif de magicien. Les dégâts, jets de sauvegarde, résistances, immunités et effets secondaires doivent être appliqués selon la règle du sort et l’arbitrage du MD.",
  "dice": "1d6+level",
  "modes": [
    {
      "id": "normal",
