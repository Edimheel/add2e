// ADD2E — onUse Magicien : Main de force de Bigby
// Version : 2026-05-05-magicien-n1-9-v2
// Retour attendu : true = sort consommé, false = sort non consommé.

const ADD2E_SORT_CONFIG = {
  "name": "Main de force de Bigby",
  "slug": "main_de_force_de_bigby",
  "level": 6,
  "kind": "condition",
  "description": "Main de force de Bigby applique un état ou une transformation : charme, peur, invisibilité, paralysie, rapidité, ralentissement, métamorphose ou effet comparable. Le script pose un effet actif de suivi.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Main de force de Bigby"
    }
  ]
};
