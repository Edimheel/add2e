// ADD2E — onUse Clerc niveaux 5-7 : Parole sacrée/maudite
...
const ADD2E_SORT_CONFIG = {
  "name": "Parole sacrée/maudite",
  "slug": "parole_sacree_maudite",
  "level": 7,
  "script_type": "holy_word",
  "description": "Parole sacrée/maudite impose, retire ou transforme un état important. Le script crée un effet actif, note la contrainte ou retire les états reconnus lorsque c’est possible. Les cas ambigus restent à valider par le MD.",
  "effect_rounds": 0,
  "effectTags": [
    "parole:sacree",
    "parole:maudite",
