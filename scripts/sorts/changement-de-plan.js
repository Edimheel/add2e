// ADD2E — onUse Clerc niveaux 5-7 : Changement de plan
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "changement_de_plan",
  "level": 5,
  "script_type": "plane_shift",
  "description": "Changement de plan produit un déplacement magique ou un passage surnaturel. La destination, les limites de transport, les risques, les restrictions de plan et les protections éventuelles sont fixés par les règles du sort et par le MD selon la scène.",
  "effect_rounds": 0,
  "effectTags": [
    "voyage:plans",
    "transport:plan"
