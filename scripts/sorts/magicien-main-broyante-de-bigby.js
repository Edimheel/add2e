// ADD2E — onUse Magicien : Main broyante de Bigby
// Version : 2026-05-05-magicien-n1-9-v2
// Retour attendu : true = sort consommé, false = sort non consommé.

const ADD2E_SORT_CONFIG = {
  "name": "Main broyante de Bigby",
  "slug": "main_broyante_de_bigby",
  "level": 9,
  "kind": "damage",
  "description": "Main broyante de Bigby produit un effet offensif de magicien. Les dégâts, jets de sauvegarde, résistances, immunités et effets secondaires doivent être appliqués selon la règle du sort et l’arbitrage du MD.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Main broyante de Bigby"
    }
  ]
};
