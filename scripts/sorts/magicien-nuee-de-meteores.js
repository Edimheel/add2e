// ADD2E — onUse Magicien : Nuée de météores
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "nuee_de_meteores",
  "level": 9,
  "kind": "damage",
  "description": "Nuée de météores produit un effet offensif de magicien. Les dégâts, jets de sauvegarde, résistances, immunités et effets secondaires doivent être appliqués selon la règle du sort et l’arbitrage du MD.",
  "dice": "special",
  "modes": [
    {
      "id": "normal",
      "label": "Nuée de météores"
    }
  ]
};
