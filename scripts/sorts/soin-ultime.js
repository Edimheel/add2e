// ADD2E — onUse Clerc niveaux 5-7 : Soin ultime
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "soin_ultime",
  "level": 5,
  "script_type": "heal_critical",
  "description": "Soin ultime restaure la vitalité, la vie ou l’intégrité d’une créature. Selon le sort, il peut soigner des blessures, rappeler une créature à la vie, régénérer un membre, retirer un affaiblissement ou restaurer une condition perdue. Les limites exactes dépendent du sort et du MD.",
  "effect_rounds": 0,
  "effectTags": [
    "soin:3d8+3"
  ],
