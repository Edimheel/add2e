// ADD2E — onUse Druide niveau 5 : Communion avec la nature
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "communion_avec_la_nature",
  "level": 5,
  "classe": "Druide",
  "script_type": "detection",
  "description": "Communion avec la nature permet au druide d’obtenir une perception surnaturelle liée à la nature, à la magie, aux créatures ou au danger recherché. La portée, l’orientation, les obstacles, les protections magiques et la précision de la recherche sont toujours pris en compte par le MD.",
  "effect_rounds": 0,
  "effectTags": [
    "communion:nature",
    "divination:nature"
