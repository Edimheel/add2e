// ADD2E — onUse Druide niveau 5 : Contrôle des vents
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "controle_des_vents",
  "level": 5,
  "classe": "Druide",
  "script_type": "note",
  "description": "Contrôle des vents modifie le terrain, les plantes, les eaux, la pierre, le bois, le métal ou la météo. L’effet est principalement tactique et scénographique : le MD fixe les dimensions exactes, la praticabilité, les dégâts éventuels et les conséquences durables.",
  "effect_rounds": 0,
  "effectTags": [
    "controle:vents",
    "air"
