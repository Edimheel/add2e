// ADD2E — onUse Magicien : Inversion de la gravité
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "inversion_de_la_gravite",
  "level": 7,
  "kind": "utility",
  "description": "Inversion de la gravité produit un effet utilitaire de magicien. Le script conserve la structure ADD2E, affiche un message de chat et crée un suivi si nécessaire.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Inversion de la gravité"
    }
  ]
};
