// ADD2E — onUse Magicien : Protection contre le mal sur 3 m
// Version : 2026-05-05-magicien-n1-9-v2
// Retour attendu : true = sort consommé, false = sort non consommé.

const ADD2E_SORT_CONFIG = {
  "name": "Protection contre le mal sur 3 m",
  "slug": "protection_contre_le_mal_sur_3_m",
  "level": 3,
  "kind": "protection",
  "description": "Protection contre le mal sur 3 m applique une défense, une barrière ou une protection magique. Le script crée un effet actif de suivi afin que le sort soit visible et exploitable dans Foundry.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Protection contre le mal sur 3 m"
    }
  ]
};
