// ADD2E — onUse Magicien : Épée de Mordenkainen
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "epee_de_mordenkainen",
  "level": 7,
  "kind": "utility",
  "description": "Épée de Mordenkainen produit un effet utilitaire de magicien. Le script conserve la structure ADD2E, affiche un message de chat et crée un suivi si nécessaire.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Épée de Mordenkainen"
    }
  ]
};
