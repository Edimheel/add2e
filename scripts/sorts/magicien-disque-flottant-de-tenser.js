// ADD2E — onUse Magicien : Disque flottant de Tenser
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "disque_flottant_de_tenser",
  "level": 1,
  "kind": "utility",
  "description": "Disque flottant de Tenser produit un effet utilitaire de magicien. Le script conserve la structure ADD2E, affiche un message de chat et crée un suivi si nécessaire.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Disque flottant de Tenser"
    }
  ]
};
