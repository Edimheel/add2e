// ADD2E — onUse Magicien : Phytomorphose
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 4,
  "kind": "utility",
  "description": "Phytomorphose produit un effet utilitaire de magicien. Le script conserve la structure ADD2E, affiche un message de chat et crée un suivi si nécessaire.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
