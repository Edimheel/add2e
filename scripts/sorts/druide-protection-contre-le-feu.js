// ADD2E — onUse Druide niveau 3 : Protection contre le feu
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "protection_contre_le_feu",
  "level": 3,
  "classe": "Druide",
  "script_type": "simple_effect",
  "description": "Protection contre le feu place une protection naturelle ou druidique sur une créature, une zone ou le lanceur. L’effet doit être pris en compte lors des attaques, jets de sauvegarde, déplacements ou interactions avec les créatures et éléments concernés. Les limites exactes dépendent de la scène et de la règle du sort.",
  "effect_rounds": "special",
  "effectTags": [
    "protection:feu",
    "resistance:feu",
    "absorption:feu"
  ...
  "modes": [
    {
      "id": "normal",
      "label": "Protection contre le feu"
    }
  ],
  "dice": null
};
