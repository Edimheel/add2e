// ADD2E — onUse Illusionniste niveau 5 : Holographie
...
const ADD2E_SORT_CONFIG = {
  ...
  "script_type": "note",
  "description": "Holographie crée, modifie ou maintient une illusion. La perception des créatures, les interactions physiques, les sauvegardes éventuelles et les limites de vraisemblance sont déterminées par les règles du sort et par le MD.",
  "effect_rounds": 0,
  "effectTags": [
    "illusion:holographie"
  ],
  "modes": [
    {
      "id": "normal",
