// ADD2E — onUse Illusionniste niveau 3 : Lumière éternelle
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "lumiere_eternelle",
  "level": 3,
  "classe": "Illusionniste",
  "script_type": "simple_effect",
  "description": "Lumière éternelle modifie une zone, un mur, un brouillard, un terrain, une lumière ou un environnement. Le script crée un suivi exploitable ; les dimensions exactes et conséquences sont gérées par le MD.",
  "effect_rounds": 0,
  "effectTags": [
    "lumiere:eternelle",
    "permanent"
