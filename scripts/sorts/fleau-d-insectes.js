// ADD2E — onUse Clerc niveaux 5-7 : Fléau d'insectes
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "fleau_d_insectes",
  "level": 5,
  "script_type": "summon_note",
  "description": "Fléau d'insectes appelle, invoque ou commande une créature ou une force extérieure. Le script note l’invocation et ses paramètres ; le MD crée ou lie ensuite les acteurs correspondants depuis le bestiaire si nécessaire.",
  "effect_rounds": "level",
  "effectTags": [
