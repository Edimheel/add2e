// ADD2E — onUse Druide niveau 5 : Bâtons à serpents
...
const ADD2E_SORT_CONFIG = {
  "name": "Bâtons à serpents",
  "slug": "batons_a_serpents",
  "level": 5,
  "classe": "Druide",
  "script_type": "summon_note",
  "description": "Bâtons à serpents appelle, invoque ou mobilise une créature, une force naturelle ou un phénomène vivant. Le script note l’invocation ; le MD crée ou lie ensuite les acteurs nécessaires depuis le bestiaire et fixe leur comportement selon la règle du sort.",
  "effect_rounds": "2*level",
  "effectTags": [
    "transmutation:batons_serpents",
    "serpents"
  ],
  "modes": [
    {
