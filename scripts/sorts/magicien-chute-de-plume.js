// ADD2E — onUse Magicien : Chute de plume
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 1,
  "kind": "movement",
  "description": "Chute de plume permet un déplacement, un passage, une lévitation, un vol, une téléportation ou une transition magique. Le MD valide les limites et la destination.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Chute de plume"
    }
  ]
};
