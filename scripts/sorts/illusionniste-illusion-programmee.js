// ADD2E — onUse Illusionniste niveau 6 : Illusion programmée
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "illusion_programmee",
  "level": 6,
  "classe": "Illusionniste",
  "script_type": "note",
  "description": "Illusion programmée crée, modifie ou maintient une illusion. La perception des créatures, les interactions physiques, les sauvegardes éventuelles et les limites de vraisemblance sont déterminées par les règles du sort et par le MD.",
  "effect_rounds": 0,
  "effectTags": [
    "illusion:programmee",
    "declencheur"
