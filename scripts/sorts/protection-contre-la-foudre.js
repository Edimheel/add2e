// ADD2E — onUse Clerc niveau 4 : Protection contre la Foudre
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "protection_contre_la_foudre",
  "script_type": "protection_lightning",
  "description": "Protège une créature contre la foudre et les décharges électriques. Le sort peut absorber ou réduire les dégâts électriques jusqu’à une limite dépendant du niveau du clerc, puis disparaître quand cette protection est épuisée. Il protège aussi contre certains effets secondaires de l’électricité selon l’arbitrage du MD.",
  "effect_rounds": 0,
  "effectTags": [
    "protection:foudre",
    "resistance:electricite",
    "absorption:foudre"
  ],
  "modes": [
    {
