// ADD2E — onUse Clerc niveau 2 : Messager
...
const ADD2E_SORT_CONFIG = {
  "name": "Messager",
  "slug": "messager",
  "script_type": "messenger",
  "description": "Le clerc désigne une petite créature, généralement un animal, et lui confie un message ou une destination. La créature part porter le message vers une personne, un lieu ou une direction indiquée, dans les limites de ses capacités naturelles et de ce qu’elle peut comprendre. Le sort ne transforme pas l’animal en serviteur intelligent : il l’oriente et le pousse à accomplir une mission simple. Les dangers du trajet, la reconnaissance du destinataire et le retour éventuel sont arbitrés par le MD.",
  "effect_rounds": 0,
  "effectTags": [
    "messager",
    "communication",
