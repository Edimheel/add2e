// ADD2E — onUse Magicien : Transformation d’objets
// Version : 2026-05-05-magicien-n1-9-v2
// Retour attendu : true = sort consommé, false = sort non consommé.

const ADD2E_SORT_CONFIG = {
  "name": "Transformation d’objets",
  "slug": "transformation_d_objets",
  "level": 8,
  "kind": "condition",
  "description": "Transformation d’objets applique un état ou une transformation : charme, peur, invisibilité, paralysie, rapidité, ralentissement, métamorphose ou effet comparable. Le script pose un effet actif de suivi.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Transformation d’objets"
    }
  ]
};
