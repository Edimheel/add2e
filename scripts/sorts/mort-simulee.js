// ADD2E — onUse Clerc niveau 3 : Mort Simulée
...
const ADD2E_SORT_CONFIG = {
  ...
  "description": "Place la cible dans un état indiscernable de la mort pour une observation ordinaire. Les fonctions vitales sont ralenties, la cible ne réagit pas, mais elle n’est pas réellement morte. Le sort peut servir à tromper un adversaire ou à ralentir certains effets.",
