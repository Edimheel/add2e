// ADD2E — onUse Clerc niveaux 5-7 : Dissipation du mal
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "dissipation_du_mal",
  "level": 5,
  "script_type": "simple_effect",
  "description": "Dissipation du mal applique une protection ou une dissipation divine. L’effet est noté par un effet actif et doit être pris en compte lors des jets de sauvegarde, attaques, influences magiques ou interactions avec les créatures concernées.",
  "effect_rounds": "level",
  "effectTags": [
    "dissipation:mal",
    "protection:mal",
