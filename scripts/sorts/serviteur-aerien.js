// ADD2E — onUse Clerc niveaux 5-7 : Serviteur aérien
...
const ADD2E_SORT_CONFIG = {
  "name": "Serviteur aérien",
  "slug": "serviteur_aerien",
  "level": 6,
  "script_type": "summon_note",
  "description": "Serviteur aérien appelle, invoque ou commande une créature ou une force extérieure. Le script note l’invocation et ses paramètres ; le MD crée ou lie ensuite les acteurs correspondants depuis le bestiaire si nécessaire.",
  "effect_rounds": "day",
  "effectTags": [
    "invocation:serviteur_aerien",
    "element:air"
  ],
  "modes": [
    {
      "id": "normal",
      "label": "Serviteur aérien"
    }
  ],
  "dice": null
};
