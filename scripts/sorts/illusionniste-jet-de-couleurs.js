// ADD2E — onUse Illusionniste niveau 1 : Jet de couleurs
...
const ADD2E_SORT_CONFIG = {
  "name": "Jet de couleurs",
  "slug": "jet_de_couleurs",
  "level": 1,
  "classe": "Illusionniste",
  "script_type": "damage_roll",
  "description": "Jet de couleurs applique un état mental, sensoriel ou magique : confusion, peur, cécité, surdité, paralysie, invisibilité, suggestion ou trouble. Le script crée un effet actif de suivi sur la cible.",
  "effect_rounds": 0,
  "effectTags": [
    "jet:couleurs",
    "aveuglement",
