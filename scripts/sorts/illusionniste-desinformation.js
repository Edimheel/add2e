// ADD2E — onUse Illusionniste niveau 2 : Désinformation
...
const ADD2E_SORT_CONFIG = {
  ...
  "description": "Désinformation applique une protection, une dissipation, un écran ou une défense magique. Le script pose un effet actif avec les tags nécessaires pour que la mécanique ADD2E puisse l’exploiter si elle existe.",
  "effect_rounds": "level",
  "effectTags": [
    "desinformation",
    "anti:divination"
