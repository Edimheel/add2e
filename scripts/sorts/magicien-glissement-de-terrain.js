// ADD2E — onUse Magicien : Glissement de terrain
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "glissement_de_terrain",
  "level": 6,
  "kind": "terrain",
  "description": "Glissement de terrain modifie une zone, un terrain, une matière, un mur, une porte ou un environnement. Les dimensions et conséquences exactes sont fixées par le MD.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
