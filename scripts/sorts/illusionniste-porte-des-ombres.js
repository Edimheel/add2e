// ADD2E — onUse Illusionniste niveau 5 : Porte des ombres
...
const ADD2E_SORT_CONFIG = {
  "name": "Porte des ombres",
  "slug": "porte_des_ombres",
  "level": 5,
  "classe": "Illusionniste",
  "script_type": "note",
  "description": "Porte des ombres permet un passage, une mobilité magique, une porte, un labyrinthe, un voyage ou un déplacement extraordinaire. La destination, les risques et les limites sont fixés par le MD.",
  "effect_rounds": 0,
  "effectTags": [
    "porte:ombres",
    "deplacement:ombre"
