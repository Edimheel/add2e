// ADD2E — onUse Clerc niveau 4 : Détection des Mensonges
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "detection_des_mensonges",
  "script_type": "detect_lie",
  "description": "Le clerc perçoit si une créature profère volontairement un mensonge. Le sort ne révèle pas automatiquement la vérité et ne détecte pas une erreur sincère, une omission, une formulation trompeuse ou une illusion dont la cible est elle-même convaincue. La forme inverse peut masquer le mensonge contre ce type de divination.",
  "effect_rounds": "level",
  "effectTags": [
    "detection:mensonge",
    "divination",
  ...
  "modes": [
    {
      "id": "normal",
      "label": "Détection des Mensonges"
    },
    {
      "id": "inverse",
      "label": "Dissimulation des Mensonges"
    }
  ]
};
