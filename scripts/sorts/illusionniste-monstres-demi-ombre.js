// ADD2E — onUse Illusionniste niveau 5 : Monstres demi-ombre
...
const ADD2E_SORT_CONFIG = {
  "name": "Monstres demi-ombre",
  "slug": "monstres_demi_ombre",
  "level": 5,
  "classe": "Illusionniste",
  "script_type": "summon_note",
  "description": "Monstres demi-ombre invoque ou façonne des créatures, forces ou ombres issues de l’illusion. Le script note l’invocation ; le MD crée ou lie ensuite l’acteur utile depuis le bestiaire si nécessaire.",
  "effect_rounds": "level",
  "effectTags": [
    "monstres:demi_ombre"
  ],
