// ADD2E — onUse Druide niveau 5 : Passe-plantes
...
const ADD2E_SORT_CONFIG = {
  ...
  "classe": "Druide",
  "script_type": "note",
  "description": "Passe-plantes facilite un déplacement naturel ou surnaturel par les plantes, les airs, l’eau, le vent ou un élément. La destination, le passage, la durée et les limites exactes dépendent de la scène et de l’arbitrage du MD.",
  "effect_rounds": 0,
  "effectTags": [
    "deplacement:plantes",
    "passage:vegetal"
