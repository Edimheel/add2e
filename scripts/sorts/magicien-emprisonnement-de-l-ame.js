// ADD2E — onUse Magicien : Emprisonnement de l’âme
// Version : 2026-05-05-magicien-n1-9-v2
// Retour attendu : true = sort consommé, false = sort non consommé.

const ADD2E_SORT_CONFIG = {
  "name": "Emprisonnement de l’âme",
  "slug": "emprisonnement_de_l_ame",
  "level": 8,
  "kind": "condition",
  "description": "Emprisonnement de l’âme applique un état ou une transformation : charme, peur, invisibilité, paralysie, rapidité, ralentissement, métamorphose ou effet comparable. Le script pose un effet actif de suivi.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Emprisonnement de l’âme"
    }
  ]
};
