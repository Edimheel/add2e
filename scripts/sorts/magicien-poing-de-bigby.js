// ADD2E — onUse Magicien : Poing de Bigby
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 8,
  "kind": "damage",
  "description": "Poing de Bigby produit un effet offensif de magicien. Les dégâts, jets de sauvegarde, résistances, immunités et effets secondaires doivent être appliqués selon la règle du sort et l’arbitrage du MD.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Poing de Bigby"
    }
  ]
};
