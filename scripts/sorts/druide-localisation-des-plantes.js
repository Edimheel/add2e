// ADD2E — onUse Druide niveau 2 : Localisation des plantes
...
const ADD2E_SORT_CONFIG = {
  "name": "Localisation des plantes",
  "slug": "localisation_des_plantes",
  "level": 2,
  "classe": "Druide",
  "script_type": "detection",
  "description": "Localisation des plantes permet au druide d’obtenir une perception surnaturelle liée à la nature, à la magie, aux créatures ou au danger recherché. La portée, l’orientation, les obstacles, les protections magiques et la précision de la recherche sont toujours pris en compte par le MD.",
  "effect_rounds": "level",
  "effectTags": [
    "localisation:plantes",
    "detection:plante"
  ],
  "modes": [
    {
      "id": "normal",
      "label": "Localisation des plantes"
    }
  ],
  "dice": null
};
