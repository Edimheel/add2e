// ADD2E — onUse Druide niveau 1 : Localisation des animaux
...
const ADD2E_SORT_CONFIG = {
  "name": "Localisation des animaux",
  "slug": "localisation_des_animaux",
  "level": 1,
  "classe": "Druide",
  "script_type": "detection",
  "description": "Localisation des animaux permet au druide d’obtenir une perception surnaturelle liée à la nature, à la magie, aux créatures ou au danger recherché. La portée, l’orientation, les obstacles, les protections magiques et la précision de la recherche sont toujours pris en compte par le MD.",
  "effect_rounds": "level",
  "effectTags": [
    "localisation:animaux",
    "detection:animal"
  ],
  "modes": [
    {
      "id": "normal",
      "label": "Localisation des animaux"
    }
  ],
  "dice": null
};
