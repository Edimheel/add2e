// ADD2E — onUse Clerc niveau 3 : Prière
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "priere",
  "script_type": "prayer",
  "description": "La prière du clerc favorise ses alliés et défavorise ses adversaires dans une zone autour de lui. Les alliés reçoivent un bonus aux attaques, dégâts et jets de protection, tandis que les ennemis subissent l’équivalent en malus pendant la durée.",
  "effect_rounds": "level",
  "effectTags": [
    "bonus:allies:1",
    "malus:ennemis:1",
