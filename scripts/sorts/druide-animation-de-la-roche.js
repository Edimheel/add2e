// ADD2E — onUse Druide niveau 7 : Animation de la roche
...
const ADD2E_SORT_CONFIG = {
  "name": "Animation de la roche",
  "slug": "animation_de_la_roche",
  "level": 7,
  "classe": "Druide",
  "script_type": "summon_note",
  "description": "Animation de la roche appelle, invoque ou mobilise une créature, une force naturelle ou un phénomène vivant. Le script note l’invocation ; le MD crée ou lie ensuite les acteurs nécessaires depuis le bestiaire et fixe leur comportement selon la règle du sort.",
  "effect_rounds": "level",
  "effectTags": [
    "animation:roche",
    "element:pierre"
