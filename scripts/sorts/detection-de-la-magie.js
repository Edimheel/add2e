...
const ADD2E_CLERIC_ONUSE_CONFIG = {
  ...
  "rule": "Permet de percevoir les émanations magiques dans la direction du regard et d’estimer leur intensité.",
  "name": "Détection de la magie",
  "slug": "detection-de-la-magie",
  "imgFallback": "systems/add2e/assets/icones/sorts/detection-magie.webp"
};
...
if (__add2eOnUseResult !== true && __add2eOnUseResult !== false) {
  console.error("[ADD2E][ONUSE][BAD_RETURN_STRICT] Le script onUse doit retourner true ou false.", {
    script: "detection-de-la-magie.js",
