// ADD2E — onUse Illusionniste niveau 4 : Dissipation de l’épuisement
...
const ADD2E_SORT_CONFIG = {
  "name": "Dissipation de l’épuisement",
  "slug": "dissipation_de_l_epuisement",
  "level": 4,
  "classe": "Illusionniste",
  "script_type": "remove_condition",
  "description": "Dissipation de l’épuisement applique un état mental, sensoriel ou magique : confusion, peur, cécité, surdité, paralysie, invisibilité, suggestion ou trouble. Le script crée un effet actif de suivi sur la cible.",
  "effect_rounds": 0,
  "effectTags": [
    "retire:epuisement",
    "fatigue"
  ...
  "modes": [
    {
      "id": "normal",
      "label": "Dissipation de l’épuisement"
    }
  ],
  "dice": null
};
