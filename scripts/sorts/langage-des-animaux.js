// ADD2E — onUse Clerc niveau 2 : Langage des Animaux
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "langage_des_animaux",
  "script_type": "communication",
  "description": "Le clerc peut parler avec un animal à sang chaud ou froid possédant un esprit animal. Il peut poser des questions, recevoir des réponses compréhensibles et établir une relation temporairement pacifiée. Un animal d’alignement ou de disposition opposée ne l’attaque normalement pas pendant la durée du sort, pas plus que ses congénères proches. Un animal neutre ou favorable peut rendre service selon une réaction déterminée par le MD, influencée par le charisme du clerc et son comportement. Le sort ne permet pas de parler aux monstres, mais aux animaux ordinaires.",
