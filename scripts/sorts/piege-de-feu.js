// ADD2E — onUse Clerc niveau 2 : Piège de Feu
...
const ADD2E_SORT_CONFIG = {
  "name": "Piège de Feu",
  "slug": "piege_de_feu",
  "script_type": "fire_trap",
  "description": "Le clerc place une protection magique sur un objet fermé ou ouvrable, comme un coffre, un livre, un coffret ou une porte. Si une créature non autorisée l’ouvre ou le manipule, le piège se déclenche et libère une explosion de feu. Un jet de protection peut réduire les dégâts selon la règle. Le piège reste jusqu’à déclenchement, dissipation ou ouverture correcte par le lanceur ou une personne autorisée. Les composantes et les conditions d’installation sont importantes : le sort sert à protéger un objet précis, pas une zone vague.",
  "effect_rounds": 0,
  "effectTags": [
    "piege:feu",
    "degat:feu",
