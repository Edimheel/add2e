// ADD2E — onUse Magicien : Nuage létal
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 5,
  "kind": "damage",
  "description": "Nuage létal produit un effet offensif de magicien. Les dégâts, jets de sauvegarde, résistances, immunités et effets secondaires doivent être appliqués selon la règle du sort et l’arbitrage du MD.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
