// ADD2E — onUse Clerc niveau 3 : Pyrotechnie
...
const ADD2E_SORT_CONFIG = {
  "name": "Pyrotechnie",
  "slug": "pyrotechnie",
  "script_type": "pyrotechnics",
  "description": "Transforme une source de feu existante en explosion lumineuse aveuglante ou en épais nuage de fumée. Le feu utilisé peut être réduit ou éteint selon la taille de l’effet choisi. Les jets de protection et la gêne dépendent de la forme utilisée.",
  "effect_rounds": 0,
  "effectTags": [
    "feu",
    "fumee",
