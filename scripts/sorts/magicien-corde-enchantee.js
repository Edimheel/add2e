// ADD2E — onUse Magicien : Corde enchantée
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 2,
  "kind": "terrain",
  "description": "Corde enchantée modifie une zone, un terrain, une matière, un mur, une porte ou un environnement. Les dimensions et conséquences exactes sont fixées par le MD.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
