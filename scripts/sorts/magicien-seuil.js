// ADD2E — Seuil — propriétaire onUse unique Clerc / Magicien
// Compatible Foundry V13/V14/V15.
// Le fichier conserve la résolution commune du sort sans créer de moteur parallèle de déplacement ou de vieillissement.

const ADD2E_SEUIL_VERSION = "2026-08-09-shared-seuil-v5";
...
async function add2eSeuilChat(caster, casterToken, note) {
  ...
  const options = {
    ...
    chatData: {
      ...
      flags: {
        add2e: {
          spell: ADD2E_SEUIL_CONFIG.slug,
          version: ADD2E_SEUIL_VERSION
        }
      }
    }
  };
