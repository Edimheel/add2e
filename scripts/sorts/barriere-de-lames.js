// ADD2E — onUse Clerc niveaux 5-7 : Barrière de lames
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "barriere_de_lames",
  "level": 6,
  "script_type": "area_damage",
  "description": "Barrière de lames inflige un effet offensif divin. Les dégâts, les jets de protection éventuels, les résistances et les effets secondaires sont résolus selon les règles du sort, la cible, la portée, les obstacles et l’arbitrage du MD.",
  "effect_rounds": 0,
  "effectTags": [
    "barriere:lames",
    "degat:tranchant",
