// ADD2E — onUse Clerc niveau 3 : Arbre
...
const ADD2E_SORT_CONFIG = {
  "name": "Arbre",
  "slug": "arbre",
  "script_type": "self_effect",
  "description": "Transforme le clerc en arbre vivant apparemment ordinaire. Il conserve sa conscience, peut observer ce qui l’entoure et peut mettre fin au sort. Sous cette forme, il est très difficile à distinguer d’un arbre naturel, mais il reste vulnérable aux effets qui menacent réellement le bois ou les plantes.",
  "effect_rounds": "60+10*level",
  "effectTags": [
    "forme:arbre",
    "camouflage:vegetal",
    "etat:arbre"
