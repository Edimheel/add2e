...
const ADD2E_CLERIC_ONUSE_CONFIG = {
  "kind": "detection",
  "durationRounds": "level*4",
  "targetLabel": "Direction observée",
  "fields": [
    {
      "name": "direction",
      "label": "Direction observée",
      "type": "text",
  ...
  "rule": "Permet de détecter les collets, fosses et pièges naturels ou sylvestres dans la direction observée. Sous terre, seules les fosses sont normalement détectées.",
  "name": "Détection des Collets et des Fosses",
  "slug": "detection-des-collets-et-des-fosses",
  "imgFallback": "systems/add2e/assets/icones/sorts/detection-des-collets-et-des-fosses.webp"
};
...
if (__add2eOnUseResult !== true && __add2eOnUseResult !== false) {
  console.error("[ADD2E][ONUSE][BAD_RETURN_STRICT] Le script onUse doit retourner true ou false.", {
    script: "detection-des-collets-et-des-fosses.js",
