// ADD2E — onUse Druide niveau 6 : Soin ultime
...
const ADD2E_SORT_CONFIG = {
  ...
  "classe": "Druide",
  "script_type": "heal",
  "description": "Soin ultime restaure la vitalité d’une créature vivante. Le soin ne dépasse pas le maximum normal de points de vie, sauf règle contraire. Le sort n’affecte normalement pas les morts-vivants ni les créatures incapables de recevoir des soins vitaux.",
  "effect_rounds": 0,
  "effectTags": [
    "soin:3d8+3"
  ],
