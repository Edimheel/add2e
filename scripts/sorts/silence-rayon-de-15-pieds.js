// ADD2E — onUse Clerc niveau 2 : Silence (Rayon de 15 pieds)
...
const ADD2E_SORT_CONFIG = {
  "name": "Silence (Rayon de 15 pieds)",
  "slug": "silence_rayon_de_15_pieds",
  "script_type": "silence",
  "description": "Le clerc crée une zone de silence d’un rayon de 15 pieds. Aucun son ne sort de la zone et les sons extérieurs n’y sont pas entendus normalement. Les conversations deviennent impossibles et les sorts nécessitant une composante verbale ne peuvent pas être lancés dans la zone. Le sort peut être centré sur un point, un objet ou une créature ; si la cible mobile est affectée, la zone se déplace avec elle. Une créature non consentante peut bénéficier du jet de protection prévu.",
  ...
  "modes": [
    {
      "id": "normal",
      "label": "Silence (Rayon de 15 pieds)"
    }
  ]
};
