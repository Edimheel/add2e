...
const ADD2E_CLERIC_ONUSE_CONFIG = {
  "kind": "touchEffect",
  "durationRounds": "10+level",
  "effectName": "Invisibilité aux Animaux",
  "tags": [
  ...
  "rule": "Rend la créature touchée indétectable aux animaux normaux d’intelligence faible. Les créatures magiques ou très intelligentes ne sont pas concernées.",
  "name": "Invisibilité aux Animaux",
  "slug": "invisibilite-aux-animaux",
  "imgFallback": "systems/add2e/assets/icones/sorts/invisibilite-aux-animaux.webp"
};
...
if (__add2eOnUseResult !== true && __add2eOnUseResult !== false) {
  console.error("[ADD2E][ONUSE][BAD_RETURN_STRICT] Le script onUse doit retourner true ou false.", {
    script: "invisibilite-aux-animaux.js",
