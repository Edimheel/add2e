// ADD2E — onUse Clerc niveau 2 : Lame Enflammée
...
const ADD2E_SORT_CONFIG = {
  "name": "Lame Enflammée",
  "slug": "lame_enflammee",
  "script_type": "flame_blade",
  "description": "Le clerc crée une lame de feu dans sa main. Elle éclaire comme une flamme et peut être utilisée comme arme magique pendant 4 rounds + 1 round par niveau. La lame touche comme une arme tenue par le clerc, inflige des dégâts de feu et peut être particulièrement efficace contre les créatures sensibles aux flammes. Elle ne peut pas être transmise comme une arme ordinaire et disparaît à la fin du sort ou si les conditions de maintien ne sont plus remplies. Les interactions avec l’eau, les résistances au feu et les immunités sont arbitrées par le MD.",
