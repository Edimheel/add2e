// ADD2E — onUse Clerc niveau 2 : Connaissance des Alignements
...
const ADD2E_SORT_CONFIG = {
  "name": "Connaissance des Alignements",
  "slug": "connaissance_des_alignements",
  "script_type": "detection",
  "description": "Le clerc peut connaître l’alignement d’une créature examinée, à raison d’une créature par round, jusqu’à dix créatures pendant la durée du sort. Le sort peut être contrarié par certains objets ou protections magiques. La forme inversée, confusion ou dissimulation de l’alignement, masque l’alignement réel d’une créature pendant la durée prévue et rend inefficace une nouvelle tentative de connaissance des alignements tant que la protection reste active.",
  "effect_rounds": 10,
  "effectTags": [
  ...
  "modes": [
    {
      "id": "normal",
      "label": "Connaissance des Alignements"
    }
  ]
};
