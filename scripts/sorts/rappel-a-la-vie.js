// ADD2E — onUse Clerc niveaux 5-7 : Rappel à la vie
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "rappel_a_la_vie",
  "level": 5,
  "script_type": "raise_dead",
  "description": "Rappel à la vie restaure la vitalité, la vie ou l’intégrité d’une créature. Selon le sort, il peut soigner des blessures, rappeler une créature à la vie, régénérer un membre, retirer un affaiblissement ou restaurer une condition perdue. Les limites exactes dépendent du sort et du MD.",
  "effect_rounds": 0,
  "effectTags": [
    "rappel:vie",
    "resurrection:mineure"
  ],
  "modes": [
    {
      "id": "normal",
      "label": "Rappel à la vie"
    }
  ],
  "dice": null
};
