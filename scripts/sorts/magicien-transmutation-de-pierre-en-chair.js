// ADD2E — onUse Magicien : Transmutation de pierre en chair
// Version : 2026-05-05-magicien-n1-9-v2
// Retour attendu : true = sort consommé, false = sort non consommé.

const ADD2E_SORT_CONFIG = {
  "name": "Transmutation de pierre en chair",
  "slug": "transmutation_de_pierre_en_chair",
  "level": 6,
  "kind": "terrain",
  "description": "Transmutation de pierre en chair modifie une zone, un terrain, une matière, un mur, une porte ou un environnement. Les dimensions et conséquences exactes sont fixées par le MD.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Transmutation de pierre en chair"
    }
  ]
};
