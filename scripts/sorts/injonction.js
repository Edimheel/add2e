...
const ADD2E_CLERIC_ONUSE_CONFIG = {
  ...
  "rule": "Le clerc prononce un ordre clair d’un seul mot dans une langue comprise par la cible. Certaines créatures intelligentes ou puissantes ont droit à un jet de protection.",
  "name": "Injonction",
  "slug": "injonction",
  "imgFallback": "systems/add2e/assets/icones/sorts/injonction.webp"
};
