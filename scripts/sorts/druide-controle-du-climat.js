// ADD2E — onUse Druide niveau 7 : Contrôle du climat
...
const ADD2E_SORT_CONFIG = {
  ...
  "classe": "Druide",
  "script_type": "note",
  "description": "Contrôle du climat modifie le terrain, les plantes, les eaux, la pierre, le bois, le métal ou la météo. L’effet est principalement tactique et scénographique : le MD fixe les dimensions exactes, la praticabilité, les dégâts éventuels et les conséquences durables.",
  "effect_rounds": 0,
  "effectTags": [
    "controle:climat",
    "meteo"
