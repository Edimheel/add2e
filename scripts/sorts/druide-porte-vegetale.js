// ADD2E — onUse Druide niveau 4 : Porte végétale
...
const ADD2E_SORT_CONFIG = {
  ...
  "classe": "Druide",
  "script_type": "note",
  "description": "Porte végétale facilite un déplacement naturel ou surnaturel par les plantes, les airs, l’eau, le vent ou un élément. La destination, le passage, la durée et les limites exactes dépendent de la scène et de l’arbitrage du MD.",
  "effect_rounds": 0,
  "effectTags": [
    "passage:vegetal",
    "deplacement:plantes"
