// ADD2E — onUse Illusionniste niveau 3 : Force spectrale
...
const ADD2E_SORT_CONFIG = {
  "name": "Force spectrale",
  "slug": "force_spectrale",
  "level": 3,
  "classe": "Illusionniste",
  "script_type": "note",
  "description": "Force spectrale crée, modifie ou maintient une illusion. La perception des créatures, les interactions physiques, les sauvegardes éventuelles et les limites de vraisemblance sont déterminées par les règles du sort et par le MD.",
  "effect_rounds": 0,
  "effectTags": [
    "illusion:force_spectrale"
  ],
  "modes": [
    {
      "id": "normal",
      "label": "Force spectrale"
    }
  ],
  "dice": null
};
