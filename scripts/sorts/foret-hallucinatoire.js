// ADD2E — onUse Clerc niveau 4 : Forêt Hallucinatoire
...
const ADD2E_SORT_CONFIG = {
  "name": "Forêt Hallucinatoire",
  "slug": "foret_hallucinatoire",
  "script_type": "area_note",
  "description": "Le clerc fait apparaître une forêt illusoire, avec arbres, broussailles et sous-bois, qui semble réelle à distance. Les créatures qui y croient peuvent être trompées sur la nature du terrain, la visibilité et les passages. Le contact direct, la détection appropriée ou la dissipation peuvent révéler l’illusion selon les règles.",
  "effect_rounds": 0,
  "effectTags": [
    "illusion:foret",
