// ADD2E — onUse Clerc niveau 2 : Production de Flammes
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "production_de_flammes",
  "script_type": "produce_flame",
  "description": "Des flammes apparaissent dans la main du clerc. Elles peuvent fournir de la lumière, enflammer des matériaux combustibles ou être projetées ou portées en attaque selon les règles. Les flammes ne blessent pas le clerc tant que le sort est actif. La durée est de 1 round par niveau, mais chaque utilisation offensive peut réduire les flammes disponibles ou y mettre fin selon l’arbitrage du MD. Les résistances au feu, l’eau, le vent et les milieux hostiles à la flamme doivent être pris en compte.",
  "effect_rounds": "level",
  "effectTags": [
    "degat:feu",
    "lumiere",
    "etat:production_flammes"
  ],
  "modes": [
    {
      "id": "normal",
      "label": "Production de Flammes"
    }
  ]
};
