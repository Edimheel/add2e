// ADD2E — onUse Magicien : Piège à feu
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 4,
  "kind": "terrain",
  "description": "Piège à feu modifie une zone, un terrain, une matière, un mur, une porte ou un environnement. Les dimensions et conséquences exactes sont fixées par le MD.",
  "dice": "1d4+level",
  "modes": [
    {
      "id": "normal",
