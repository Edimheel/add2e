// ADD2E — onUse Clerc niveau 3 : Localisation d’un Objet
...
const ADD2E_SORT_CONFIG = {
  "name": "Localisation d’un Objet",
  "slug": "localisation_d_un_objet",
  "script_type": "locate_object",
  "description": "Permet de sentir la direction d’un objet connu ou d’un type d’objet clairement visualisé, dans les limites de portée. Les objets trop génériques, mal décrits ou uniques sans image mentale correcte peuvent échapper au sort.",
  "effect_rounds": "level",
  "effectTags": [
    "detection:objet",
    "divination",
