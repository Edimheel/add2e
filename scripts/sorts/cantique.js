...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "cantique",
  "script_type": "chant",
  "description": "Le clerc entonne un chant sacré qui renforce ses alliés et affaiblit ses ennemis. Une fois l’incantation achevée, les alliés du clerc dans la zone gagnent +1 à leurs jets d’attaque, de dégâts et de protection, tandis que les ennemis subissent –1 aux mêmes jets. L’effet dure tant que le clerc continue de chanter et reste immobile. Une attaque réussie contre lui, un sort de silence, une bousculade ou toute interruption comparable met fin au cantique. Le sort exige donc une concentration active et visible du clerc.",
  "effect_rounds": 0,
  "effectTags": [
    "bonus:toucher:1",
    "bonus:degats:1",
