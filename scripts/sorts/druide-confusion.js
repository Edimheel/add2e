// ADD2E — onUse Druide niveau 7 : Confusion
...
const ADD2E_SORT_CONFIG = {
  ...
  "description": "Confusion applique, retire ou transforme un état important : paralysie, poison, maladie, confusion, transformation ou autre condition. Le script crée ou retire les effets actifs reconnus, puis le MD tranche les cas particuliers.",
  "effect_rounds": "level",
  "effectTags": [
    "etat:confusion",
    "mental"
