// ADD2E — onUse Clerc niveau 4 : Abaissement des Eaux
...
const ADD2E_SORT_CONFIG = {
  "name": "Abaissement des Eaux",
  "slug": "abaissement_des_eaux",
  "script_type": "water_level",
  "description": "Le clerc fait baisser temporairement le niveau d’une masse d’eau dans la zone visée. Le sort peut exposer un gué, dégager une entrée submergée, diminuer la profondeur autour d’un obstacle ou rendre praticable un passage normalement noyé. L’effet dépend du volume d’eau présent, de la configuration du terrain et de l’arbitrage du MD ; l’eau revient normalement à son niveau lorsque la durée expire. La forme inverse permet de relever l’eau dans les mêmes limites générales.",
