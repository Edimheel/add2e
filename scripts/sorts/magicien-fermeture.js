// ADD2E — onUse Magicien : Fermeture
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 1,
  "kind": "protection",
  "description": "Fermeture applique une défense, une barrière ou une protection magique. Le script crée un effet actif de suivi afin que le sort soit visible et exploitable dans Foundry.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
