// ADD2E — onUse Clerc niveau 3 : Communication avec les Morts
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "communication_avec_les_morts",
  "script_type": "speak_dead",
  "description": "Permet au clerc de poser plusieurs questions à une créature morte, si le corps, les restes ou une partie suffisante sont présents. Les réponses dépendent de ce que la créature savait de son vivant, de la langue commune possible, du temps écoulé depuis la mort et du niveau du clerc.",
  "effect_rounds": 0,
  "effectTags": [
    "communication:morts",
    "question:cadavre",
