// ADD2E — onUse Clerc niveau 4 : Appel de Créatures Sylvestres
...
const ADD2E_SORT_CONFIG = {
  "name": "Appel de Créatures Sylvestres",
  "slug": "appel_de_creatures_sylvestres",
  "script_type": "summon_note",
  "description": "Le clerc appelle des créatures sylvestres présentes dans la région. Les créatures disponibles dépendent de l’environnement : bois, clairières, vallons, forêts anciennes ou lieux féeriques. Elles ne sont pas créées par le sort et conservent leur volonté ; leur aide dépend de leur nature, de l’alignement du lanceur, de la situation et de la réaction déterminée par le MD.",
  "effect_rounds": 0,
  "effectTags": [
    "appel:creatures_sylvestres",
    "nature",
    "reaction:md"
  ],
  "modes": [
    {
      "id": "normal",
      "label": "Appel de Créatures Sylvestres"
    }
  ]
};
