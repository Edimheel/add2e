// ADD2E — onUse Druide niveau 5 : Transmutation de pierre en boue
...
const ADD2E_SORT_CONFIG = {
  "name": "Transmutation de pierre en boue",
  "slug": "transmutation_de_pierre_en_boue",
  "level": 5,
  "classe": "Druide",
  "script_type": "mode_note",
  "description": "Transmutation de pierre en boue modifie le terrain, les plantes, les eaux, la pierre, le bois, le métal ou la météo. L’effet est principalement tactique et scénographique : le MD fixe les dimensions exactes, la praticabilité, les dégâts éventuels et les conséquences durables.",
  "effect_rounds": 0,
  "effectTags": [
    "transmutation:pierre_boue"
  ],
  "modes": [
    {
      "id": "pierre_boue",
      "label": "Pierre en boue"
    },
    {
      "id": "boue_pierre",
      "label": "Boue en pierre"
    }
  ],
  "dice": null
};
