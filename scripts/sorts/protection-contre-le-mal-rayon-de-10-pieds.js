// ADD2E — onUse Clerc niveau 4 : Protection contre le Mal (Rayon de 10 pieds)
...
const ADD2E_SORT_CONFIG = {
  "name": "Protection contre le Mal (Rayon de 10 pieds)",
  "slug": "protection_contre_le_mal_rayon_de_10_pieds",
  "script_type": "protection_evil_10",
  "description": "Crée autour du clerc une protection contre les créatures mauvaises ou invoquées, étendue à un rayon de 10 pieds. Les alliés dans la zone bénéficient de la protection contre les attaques et influences appropriées ; les créatures convoquées ou enchantées peuvent être tenues à distance selon les règles. La forme inverse protège contre le bien.",
