// ADD2E — onUse Illusionniste niveau 7 : Sorts de niveau 1 de magicien
...
const ADD2E_SORT_CONFIG = {
  "name": "Sorts de niveau 1 de magicien",
  "slug": "sorts_de_niveau_1_de_magicien",
  "level": 7,
  "classe": "Illusionniste",
  "script_type": "note",
  "description": "Sorts de niveau 1 de magicien donne accès ou simule un ensemble de sorts selon la règle de l’illusionniste. Le choix précis du sort reproduit, sa résolution et ses limites sont validés par le MD.",
  "effect_rounds": 0,
  "effectTags": [
    "acces:sort_magicien_niveau_1",
    "illusionniste:magicien_niveau_1"
  ],
  "modes": [
    {
      "id": "normal",
      "label": "Sorts de niveau 1 de magicien"
    }
  ],
  "dice": null
};
