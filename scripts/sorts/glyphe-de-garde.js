// ADD2E — onUse Clerc niveau 3 : Glyphe de Garde
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "glyphe_de_garde",
  "script_type": "glyph",
  "description": "Inscrit un glyphe magique sur une surface, un passage, un coffre ou une zone. Le glyphe se déclenche selon les conditions fixées par le clerc et peut produire un effet de garde, de protection ou de dégâts. Le MD détermine les détails selon le glyphe choisi.",
  "effect_rounds": 0,
  "effectTags": [
    "glyphe:garde",
    "piege:magique",
