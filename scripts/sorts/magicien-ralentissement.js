...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 3,
  "kind": "condition",
  "description": "Ralentissement applique un état ou une transformation : charme, peur, invisibilité, paralysie, rapidité, ralentissement, métamorphose ou effet comparable. Le script pose un effet actif de suivi.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
