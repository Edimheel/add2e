// ADD2E — onUse Magicien : Contact d'autres plans
// Version : 2026-05-05-magicien-n1-9-v2
// Retour attendu : true = sort consommé, false = sort non consommé.

const ADD2E_SORT_CONFIG = {
  "name": "Contact d'autres plans",
  "slug": "contact_d_autres_plans",
  "level": 5,
  "kind": "detection",
  "description": "Contact d'autres plans donne au magicien une perception, une lecture ou une information magique. Les protections, obstacles et limites exactes restent à résoudre selon la règle du sort.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Contact d'autres plans"
    }
  ]
};
