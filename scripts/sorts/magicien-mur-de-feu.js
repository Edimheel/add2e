// ADD2E — onUse Magicien : Mur de feu
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 4,
  "kind": "damage",
  "description": "Mur de feu produit un effet offensif de magicien. Les dégâts, jets de sauvegarde, résistances, immunités et effets secondaires doivent être appliqués selon la règle du sort et l’arbitrage du MD.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
