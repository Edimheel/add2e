// ADD2E — onUse Magicien : Invocation d’élémental
// Version : 2026-05-05-magicien-n1-9-v2
// Retour attendu : true = sort consommé, false = sort non consommé.

const ADD2E_SORT_CONFIG = {
  "name": "Invocation d’élémental",
  "slug": "invocation_d_elemental",
  "level": 5,
  "kind": "summon",
  "description": "Invocation d’élémental invoque, appelle ou crée une créature, un serviteur ou une force magique. Le script note l’invocation ; l’acteur correspondant doit être créé ou lié par le MD.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Invocation d’élémental"
    }
  ]
};
