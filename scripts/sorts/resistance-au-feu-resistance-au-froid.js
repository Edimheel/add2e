// ADD2E — onUse Clerc niveau 2 : Résistance au Feu/Résistance au Froid
...
const ADD2E_SORT_CONFIG = {
  "name": "Résistance au Feu/Résistance au Froid",
  "slug": "resistance_au_feu_resistance_au_froid",
  "script_type": "resist_fire_cold",
  "description": "Le clerc protège une créature touchée contre le feu ou le froid, selon la version choisie au moment de l’incantation. La protection aide contre les températures naturelles extrêmes et contre les attaques magiques ou surnaturelles de l’élément choisi. Les effets exacts peuvent inclure une réduction des dégâts, une meilleure chance de sauvegarde ou une protection complète contre de faibles intensités, selon la situation et les règles appliquées par le MD. La durée est de 1 tour par niveau.",
  "effect_rounds": "10*level",
  "effectTags": [
    "resistance:feu",
    "resistance:froid",
    "bonus:sauvegarde:element"
  ],
  "modes": [
    {
      "id": "feu",
