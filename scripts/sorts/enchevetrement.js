...
const ADD2E_CLERIC_ONUSE_CONFIG = {
  ...
  "applyOnSave": true,
  "saveEffect": {
    "effectName": "Enchevêtrement — ralenti",
    "tags": [
      "sort:enchevetrement",
      "etat:ralenti",
      "controle:zone",
  ...
  "rule": "Anime et épaissit la végétation d’une zone pour immobiliser les créatures présentes. Un jet réussi réduit l’effet à un fort ralentissement. Cible les tokens présents dans la zone avant le lancement.",
  "name": "Enchevêtrement",
  "slug": "enchevetrement",
  "imgFallback": "systems/add2e/assets/icones/sorts/enchevetrement.webp"
};
