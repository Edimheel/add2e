// ADD2E — onUse Magicien : Rafale de vent
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 3,
  "kind": "utility",
  "description": "Rafale de vent produit un effet utilitaire de magicien. Le script conserve la structure ADD2E, affiche un message de chat et crée un suivi si nécessaire.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Rafale de vent"
    }
  ]
};
