// ADD2E — onUse Clerc niveau 4 : Production de Feu
...
const ADD2E_SORT_CONFIG = {
  "name": "Production de Feu",
  "slug": "production_de_feu",
  "script_type": "produce_fire",
  "description": "Produit une flamme magique suffisante pour enflammer des combustibles, éclairer brièvement ou déclencher un effet de feu limité. La chaleur et les dégâts éventuels dépendent de l’usage, de la matière visée et de la décision du MD. Le sort peut servir d’outil ou d’attaque circonstancielle, sans créer un incendie incontrôlable au-delà de ce que permet l’environnement.",
  "effect_rounds": 0,
  "effectTags": [
    "feu",
    "creation:flamme",
