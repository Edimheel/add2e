// ADD2E — onUse Magicien : Coffre secret de Léomund
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "coffre_secret_de_leomund",
  "level": 5,
  "kind": "utility",
  "description": "Coffre secret de Léomund produit un effet utilitaire de magicien. Le script conserve la structure ADD2E, affiche un message de chat et crée un suivi si nécessaire.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Coffre secret de Léomund"
    }
  ]
};
