// ADD2E — onUse Clerc niveau 4 : Contrôle de la Température (Rayon de 10’)
...
const ADD2E_SORT_CONFIG = {
  "name": "Contrôle de la Température (Rayon de 10’)",
  "slug": "controle_de_la_temperature_rayon_de_10",
  "script_type": "temperature_control",
  "description": "Le clerc augmente ou diminue la température autour de lui dans un rayon limité. Le sort protège contre les excès de chaleur ou de froid ordinaires et peut rendre supportable un environnement hostile. Il ne transforme pas un feu ou un froid magique en effet inoffensif absolu, mais peut réduire leurs conséquences selon le MD.",
  "effect_rounds": "40+10*level",
  "effectTags": [
