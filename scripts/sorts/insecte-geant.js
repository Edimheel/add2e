// ADD2E — onUse Clerc niveau 4 : Insecte Géant
...
const ADD2E_SORT_CONFIG = {
  ...
  "description": "Le clerc grossit un ou plusieurs insectes ordinaires jusqu’à en faire des créatures de combat temporaires. Le nombre et la taille obtenus dépendent du niveau du lanceur et des insectes disponibles. Les créatures restent naturelles dans leur comportement mais peuvent être dirigées selon l’arbitrage du MD.",
  "effect_rounds": "2*level",
  "effectTags": [
    "alteration:insecte",
    "creature:insecte_geant",
    "combat"
  ],
  "modes": [
    {
