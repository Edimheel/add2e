...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "augure",
  "script_type": "augure",
  "description": "Le clerc cherche à savoir si une action que lui et ses compagnons envisagent d’entreprendre dans le futur immédiat, au maximum dans les trois prochains tours, sera favorable ou défavorable au groupe. La chance de base d’obtenir une indication correcte est de 70 % + 1 % par niveau du clerc. Le MD peut appliquer les ajustements qu’il juge nécessaires selon la clarté de la question, les circonstances et les forces opposées. La réponse doit rester brève et oraculaire : bénéfique, funeste, les deux, ou incertaine. Les composantes matérielles peuvent être des baguettes serties, des os de dragon, des objets divinatoires similaires, ou des feuilles d’infusion humides ; dans ce dernier cas, une perle broyée d’au moins 100 po est ajoutée à la boisson avant consommation.",
  "effect_rounds": 0,
  "effectTags": [
    "divination:augure",
    "information:md"
