...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 7,
  "kind": "condition",
  "description": "Statue applique un état ou une transformation : charme, peur, invisibilité, paralysie, rapidité, ralentissement, métamorphose ou effet comparable. Le script pose un effet actif de suivi.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
