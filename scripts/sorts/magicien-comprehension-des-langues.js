// ADD2E — onUse Magicien : Compréhension des langues
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "comprehension_des_langues",
  "level": 1,
  "kind": "utility",
  "description": "Compréhension des langues produit un effet utilitaire de magicien. Le script conserve la structure ADD2E, affiche un message de chat et crée un suivi si nécessaire.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
