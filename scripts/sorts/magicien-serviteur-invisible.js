// ADD2E — onUse Magicien : Serviteur invisible
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "serviteur_invisible",
  "level": 1,
  "kind": "summon",
  "description": "Serviteur invisible invoque, appelle ou crée une créature, un serviteur ou une force magique. Le script note l’invocation ; l’acteur correspondant doit être créé ou lié par le MD.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Serviteur invisible"
    }
  ]
};
