// ADD2E — onUse Druide niveau 2 : Aquagenèse
...
const ADD2E_SORT_CONFIG = {
  ...
  "classe": "Druide",
  "script_type": "note",
  "description": "Aquagenèse modifie le terrain, les plantes, les eaux, la pierre, le bois, le métal ou la météo. L’effet est principalement tactique et scénographique : le MD fixe les dimensions exactes, la praticabilité, les dégâts éventuels et les conséquences durables.",
  "effect_rounds": 0,
  "effectTags": [
    "creation:eau",
    "reversible:destruction_eau"
  ],
  "modes": [
    {
      "id": "normal",
