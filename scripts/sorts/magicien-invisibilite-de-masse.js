// ADD2E — onUse Magicien : Invisibilité de masse
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "invisibilite_de_masse",
  "level": 7,
  "kind": "condition",
  "description": "Invisibilité de masse applique un état ou une transformation : charme, peur, invisibilité, paralysie, rapidité, ralentissement, métamorphose ou effet comparable. Le script pose un effet actif de suivi.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Invisibilité de masse"
    }
  ]
};
