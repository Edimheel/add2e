// ADD2E — onUse Druide niveau 4 : Protection contre la foudre
...
const ADD2E_SORT_CONFIG = {
  ...
  "description": "Protection contre la foudre place une protection naturelle ou druidique sur une créature, une zone ou le lanceur. L’effet doit être pris en compte lors des attaques, jets de sauvegarde, déplacements ou interactions avec les créatures et éléments concernés. Les limites exactes dépendent de la scène et de la règle du sort.",
  "effect_rounds": 0,
  "effectTags": [
    "protection:foudre",
