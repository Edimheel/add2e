// ADD2E — onUse Illusionniste niveau 1 : Détection de l’invisibilité
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "detection_de_l_invisibilite",
  "level": 1,
  "classe": "Illusionniste",
  "script_type": "detection",
  "description": "Détection de l’invisibilité permet à l’illusionniste de percevoir une invisibilité, une illusion, une magie ou une information cachée. Les protections, obstacles, distances et limites de durée sont appliqués par le MD.",
  "effect_rounds": "5*level",
  "effectTags": [
  ...
  "modes": [
    {
      "id": "normal",
      "label": "Détection de l’invisibilité"
    }
  ],
  "dice": null
};
