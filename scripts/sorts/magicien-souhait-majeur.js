// ADD2E — onUse Magicien : Souhait majeur
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 9,
  "kind": "utility",
  "description": "Souhait majeur produit un effet utilitaire de magicien. Le script conserve la structure ADD2E, affiche un message de chat et crée un suivi si nécessaire.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Souhait majeur"
    }
  ]
};
