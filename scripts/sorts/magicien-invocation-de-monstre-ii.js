// ADD2E — onUse Magicien : Invocation de monstre II
// Version : 2026-05-05-magicien-n1-9-v2
// Retour attendu : true = sort consommé, false = sort non consommé.

const ADD2E_SORT_CONFIG = {
  "name": "Invocation de monstre II",
  "slug": "invocation_de_monstre_ii",
  "level": 4,
  "kind": "summon",
  "description": "Invocation de monstre II invoque, appelle ou crée une créature, un serviteur ou une force magique. Le script note l’invocation ; l’acteur correspondant doit être créé ou lié par le MD.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Invocation de monstre II"
    }
  ]
};
