// ADD2E — onUse Magicien : Immunité magique de Serten
// Version : 2026-05-05-magicien-n1-9-v2
// Retour attendu : true = sort consommé, false = sort non consommé.

const ADD2E_SORT_CONFIG = {
  "name": "Immunité magique de Serten",
  "slug": "immunite_magique_de_serten",
  "level": 8,
  "kind": "protection",
  "description": "Immunité magique de Serten applique une défense, une barrière ou une protection magique. Le script crée un effet actif de suivi afin que le sort soit visible et exploitable dans Foundry.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Immunité magique de Serten"
    }
  ]
};
