// ADD2E — onUse Clerc niveau 4 : Immobilisation des Plantes
...
const ADD2E_SORT_CONFIG = {
  "name": "Immobilisation des Plantes",
  "slug": "immobilisation_des_plantes",
  "script_type": "simple_effect",
  "description": "Immobilise les plantes animées, les créatures végétales ou la végétation active dans la zone d’effet. Les plantes ordinaires cessent de se mouvoir et les créatures végétales affectées ne peuvent plus se déplacer ou attaquer tant que le sort persiste, sous réserve du jet de protection lorsque le MD l’autorise.",
  "effect_rounds": "level",
  "effectTags": [
    "etat:immobilisation",
    "creature:vegetale",
  ...
  "modes": [
    {
      "id": "normal",
      "label": "Immobilisation des Plantes"
    }
  ]
};
