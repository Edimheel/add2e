...
const ADD2E_CLERIC_ONUSE_CONFIG = {
  ...
  "rule": "Rend 1d8 points de vie à une créature vivante blessée. N’affecte pas les morts-vivants ni les créatures sans enveloppe corporelle. Inverse : blessures légères, inflige 1d8.",
...
if (__add2eOnUseResult !== true && __add2eOnUseResult !== false) {
  console.error("[ADD2E][ONUSE][BAD_RETURN_STRICT] Le script onUse doit retourner true ou false.", {
    script: "soins-des-blessures-legeres.js",
