// ADD2E — onUse Magicien : Incantation mortelle
// Version : 2026-05-05-magicien-n1-9-v2
// Retour attendu : true = sort consommé, false = sort non consommé.

const ADD2E_SORT_CONFIG = {
  "name": "Incantation mortelle",
  "slug": "incantation_mortelle",
  "level": 6,
  "kind": "damage",
  "description": "Incantation mortelle produit un effet offensif de magicien. Les dégâts, jets de sauvegarde, résistances, immunités et effets secondaires doivent être appliqués selon la règle du sort et l’arbitrage du MD.",
  "dice": "special",
  "modes": [
    {
      "id": "normal",
      "label": "Incantation mortelle"
    }
  ]
};
