// ADD2E — onUse Magicien : Danse irrésistible d’Otto
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "danse_irresistible_d_otto",
  "level": 8,
  "kind": "condition",
  "description": "Danse irrésistible d’Otto applique un état ou une transformation : charme, peur, invisibilité, paralysie, rapidité, ralentissement, métamorphose ou effet comparable. Le script pose un effet actif de suivi.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Danse irrésistible d’Otto"
    }
  ]
};
