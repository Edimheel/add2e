// ADD2E — onUse Clerc niveau 3 : Respiration Aquatique
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "respiration_aquatique",
  "script_type": "water_breathing",
  "description": "Permet à une ou plusieurs créatures de respirer sous l’eau pendant la durée du sort. L’effet ne donne pas la capacité de nager, mais empêche la noyade tant que la créature reste sous l’eau. La durée peut être répartie entre plusieurs bénéficiaires selon les règles.",
  "effect_rounds": "60*level",
  "effectTags": [
    "respiration:eau",
    "deplacement:aquatique",
    "survie"
  ],
  "modes": [
    {
    ...
    {
      "id": "inverse",
      "label": "Respiration Aérienne"
    }
  ],
  "inverseLabel": "Respiration Aérienne",
  "inverseTags": [
    "reversible:respiration_aerienne",
    "etat:respiration_aerienne"
  ]
};
