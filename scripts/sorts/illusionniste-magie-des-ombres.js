// ADD2E — onUse Illusionniste niveau 5 : Magie des ombres
...
const ADD2E_SORT_CONFIG = {
  "name": "Magie des ombres",
  "slug": "magie_des_ombres",
  "level": 5,
  "classe": "Illusionniste",
  "script_type": "mode_note",
  "description": "Magie des ombres crée, modifie ou maintient une illusion. La perception des créatures, les interactions physiques, les sauvegardes éventuelles et les limites de vraisemblance sont déterminées par les règles du sort et par le MD.",
  "effect_rounds": 0,
  "effectTags": [
    "magie:ombres"
  ],
  "modes": [
    {
      "id": "evocation",
      "label": "Évocation d’ombre"
    },
    {
      "id": "conjuration",
      "label": "Conjuration d’ombre"
    }
  ],
  "dice": null
};
