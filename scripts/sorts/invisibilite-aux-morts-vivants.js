...
const ADD2E_CLERIC_ONUSE_CONFIG = {
  "kind": "touchEffect",
  "durationRounds": 6,
  "effectName": "Invisibilité aux Morts-Vivants",
  "tags": [
  ...
  "rule": "Rend la cible indétectable aux morts-vivants d’esprit faible. Les morts-vivants plus puissants peuvent bénéficier d’un jet de protection lors de l’interaction.",
  "name": "Invisibilité aux Morts-Vivants",
  "slug": "invisibilite-aux-morts-vivants",
  "imgFallback": "systems/add2e/assets/icones/sorts/invisibilite-aux-morts-vivants.webp"
};
...
if (__add2eOnUseResult !== true && __add2eOnUseResult !== false) {
  console.error("[ADD2E][ONUSE][BAD_RETURN_STRICT] Le script onUse doit retourner true ou false.", {
    script: "invisibilite-aux-morts-vivants.js",
