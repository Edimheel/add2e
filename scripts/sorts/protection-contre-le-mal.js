...
const ADD2E_CLERIC_ONUSE_CONFIG = {
  "kind": "touchEffect",
  "durationRounds": "level*3",
  "modes": [
    {
      "key": "mal",
      "label": "Protection contre le Mal",
      "effectName": "Protection contre le Mal",
      "tags": [
        "sort:protection_contre_le_mal",
        "protection:mal",
        "bonus_ca:2",
        "bonus_save_vs:mal:2",
        "barriere:creatures_invoquees",
        "malus_toucher_ennemi:2"
      ],
      "changes": [
        {
          "key": "system.bonus_ca",
    ...
    {
      "key": "bien",
      "label": "Protection contre le Bien",
      "effectName": "Protection contre le Bien",
      "tags": [
        "sort:protection_contre_le_bien",
        "protection:bien",
        "bonus_ca:2",
        "bonus_save_vs:bien:2",
        "barriere:creatures_invoquees",
        "malus_toucher_ennemi:2"
      ],
      "changes": [
  ...
  "rule": "Protège la cible contre les contacts corporels des créatures enchantées ou invoquées, impose –2 aux attaques des créatures mauvaises et donne +2 aux jets de protection. Inverse : protection contre le bien.",
  "name": "Protection contre le Mal",
  "slug": "protection-contre-le-mal",
  "imgFallback": "systems/add2e/assets/icones/sorts/protection-contre-le-mal.webp"
};
...
if (__add2eOnUseResult !== true && __add2eOnUseResult !== false) {
  console.error("[ADD2E][ONUSE][BAD_RETURN_STRICT] Le script onUse doit retourner true ou false.", {
    script: "protection-contre-le-mal.js",
