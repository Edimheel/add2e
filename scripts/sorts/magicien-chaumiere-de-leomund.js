// ADD2E — onUse Magicien : Chaumière de Léomund
// Version : 2026-05-05-magicien-n1-9-v2
// Retour attendu : true = sort consommé, false = sort non consommé.

const ADD2E_SORT_CONFIG = {
  "name": "Chaumière de Léomund",
  "slug": "chaumiere_de_leomund",
  "level": 3,
  "kind": "utility",
  "description": "Chaumière de Léomund produit un effet utilitaire de magicien. Le script conserve la structure ADD2E, affiche un message de chat et crée un suivi si nécessaire.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Chaumière de Léomund"
    }
  ]
};
