// ADD2E — onUse Magicien : Allométamorphose
// Version : 2026-05-05-magicien-n1-9-v2
// Retour attendu : true = sort consommé, false = sort non consommé.

const ADD2E_SORT_CONFIG = {
  "name": "Allométamorphose",
  "slug": "allometamorphose",
  "level": 4,
  "kind": "condition",
  "description": "Allométamorphose applique un état ou une transformation : charme, peur, invisibilité, paralysie, rapidité, ralentissement, métamorphose ou effet comparable. Le script pose un effet actif de suivi.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Allométamorphose"
    }
  ]
};
