// ADD2E — onUse Clerc niveau 4 : Neutralisation du Poison
...
const ADD2E_SORT_CONFIG = {
  "name": "Neutralisation du Poison",
  "slug": "neutralisation_du_poison",
  "script_type": "neutralize_poison",
  "description": "Neutralise le poison dans une créature, un objet, un aliment, une boisson ou une dose de venin. Sur une créature empoisonnée, le sort arrête l’action du poison s’il est lancé à temps ; il ne rend pas automatiquement les points de vie ou caractéristiques déjà perdus. La forme inverse peut rendre une substance toxique ou empoisonner une cible selon le jet de protection décidé par le MD.",
  "effect_rounds": 0,
  "effectTags": [
    "retire:poison",
  ...
  "modes": [
    {
      "id": "normal",
      "label": "Neutralisation du Poison"
    },
    {
      "id": "inverse",
      "label": "Poison"
