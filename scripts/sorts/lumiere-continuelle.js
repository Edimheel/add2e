// ADD2E — onUse Clerc niveau 3 : Lumière Continuelle
...
const ADD2E_SORT_CONFIG = {
  "name": "Lumière Continuelle",
  "slug": "lumiere_continuelle",
  "script_type": "continual_light",
  "description": "Crée une lumière magique permanente semblable à une lumière vive. Elle peut être placée sur un objet, un point ou une créature selon les règles. L’effet peut être couvert, dissipé ou opposé par des ténèbres magiques adaptées.",
  "effect_rounds": 0,
  "effectTags": [
    "lumiere:continuelle",
    "permanent"
  ...
  "modes": [
    {
      "id": "normal",
      "label": "Lumière Continuelle"
    },
    {
      "id": "inverse",
      "label": "Ténèbres Continuelles"
    }
  ],
  "inverseLabel": "Ténèbres Continuelles",
  "inverseTags": [
    "reversible:tenebres_continuelles",
    "etat:tenebres_continuelles"
  ]
};
