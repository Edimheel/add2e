// ADD2E — onUse Druide niveau 6 : Transit végétal
...
const ADD2E_SORT_CONFIG = {
  "name": "Transit végétal",
  "slug": "transit_vegetal",
  "level": 6,
  "classe": "Druide",
  "script_type": "note",
  "description": "Transit végétal facilite un déplacement naturel ou surnaturel par les plantes, les airs, l’eau, le vent ou un élément. La destination, le passage, la durée et les limites exactes dépendent de la scène et de l’arbitrage du MD.",
  "effect_rounds": 0,
  "effectTags": [
    "transport:plantes",
    "deplacement:vegetal"
