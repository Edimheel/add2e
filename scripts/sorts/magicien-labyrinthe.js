// ADD2E — onUse Magicien : Labyrinthe
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 8,
  "kind": "movement",
  "description": "Labyrinthe permet un déplacement, un passage, une lévitation, un vol, une téléportation ou une transition magique. Le MD valide les limites et la destination.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
