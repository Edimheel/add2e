// ADD2E — onUse Magicien : Respiration aquatique
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 3,
  "kind": "detection",
  "description": "Respiration aquatique donne au magicien une perception, une lecture ou une information magique. Les protections, obstacles et limites exactes restent à résoudre selon la règle du sort.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
