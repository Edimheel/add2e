// ADD2E — onUse Clerc niveau 3 : Croissance Végétale
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "croissance_vegetale",
  "script_type": "plant_growth",
  "description": "Force les plantes d’une zone à croître rapidement, rendant le terrain très difficile ou presque infranchissable selon la végétation initiale. Le sort peut bloquer des passages, ralentir fortement une poursuite ou transformer une zone clairesemée en obstacle naturel.",
  "effect_rounds": 0,
  "effectTags": [
    "terrain:difficile",
    "vegetation:croit",
