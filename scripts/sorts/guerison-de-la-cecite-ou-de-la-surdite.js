// ADD2E — onUse Clerc niveau 3 : Guérison de la Cécité ou de la Surdité
...
const ADD2E_SORT_CONFIG = {
  "name": "Guérison de la Cécité ou de la Surdité",
  "slug": "guerison_de_la_cecite_ou_de_la_surdite",
  "script_type": "cure_conditions",
  "description": "Met fin à une cécité ou une surdité magique ou naturelle si l’affection est de nature curable par ce sort. Ne régénère pas un organe détruit, mais annule l’état qui empêche de voir ou d’entendre lorsque le corps peut encore fonctionner.",
  "effect_rounds": 0,
  "effectTags": [
    "retire:cecite",
    "retire:surdite",
  ...
  "modes": [
    {
      "id": "normal",
      "label": "Guérison de la Cécité ou de la Surdité"
    }
  ],
  "removeTags": [
    "etat:cecite",
