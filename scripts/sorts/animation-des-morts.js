// ADD2E — onUse Clerc niveau 3 : Animation des Morts
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "animation_des_morts",
  "script_type": "animate_dead",
  "description": "Anime des ossements ou cadavres humanoïdes en squelettes ou zombies. Les morts-vivants créés obéissent au clerc, le suivent, gardent un lieu ou attaquent une créature désignée. Ils restent animés jusqu’à destruction ou dissipation. Le nombre exact dépend du niveau du clerc et des dés de vie des corps utilisés ; les créatures plus puissantes consomment davantage de potentiel d’animation.",
  "effect_rounds": 0,
  "effectTags": [
    "necromancie",
    "creation:mort_vivant",
    "controle:mort_vivant",
    "permanent"
  ],
  "modes": [
    {
      "id": "normal",
      "label": "Animation des Morts"
    }
  ]
};
