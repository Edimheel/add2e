// ADD2E — onUse Druide niveau 1 : Passage sans trace
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "passage_sans_trace",
  "level": 1,
  "classe": "Druide",
  "script_type": "simple_effect",
  "description": "Passage sans trace facilite un déplacement naturel ou surnaturel par les plantes, les airs, l’eau, le vent ou un élément. La destination, le passage, la durée et les limites exactes dépendent de la scène et de l’arbitrage du MD.",
  "effect_rounds": "10*level",
  "effectTags": [
    "deplacement:sans_trace",
    "discretion:nature"
  ],
  "modes": [
    {
