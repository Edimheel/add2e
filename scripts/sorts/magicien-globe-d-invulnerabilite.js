// ADD2E — onUse Magicien : Globe d’invulnérabilité
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "globe_d_invulnerabilite",
  "level": 6,
  "kind": "protection",
  "description": "Globe d’invulnérabilité applique une défense, une barrière ou une protection magique. Le script crée un effet actif de suivi afin que le sort soit visible et exploitable dans Foundry.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
