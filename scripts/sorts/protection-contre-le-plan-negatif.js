// ADD2E — onUse Clerc niveau 3 : Protection contre le Plan Négatif
...
const ADD2E_SORT_CONFIG = {
  "name": "Protection contre le Plan Négatif",
  "slug": "protection_contre_le_plan_negatif",
  "script_type": "target_effect",
  "description": "Protège temporairement une créature contre les effets du plan négatif, notamment certains drains d’énergie des morts-vivants. La protection peut se dissiper après avoir absorbé une attaque de ce type ou à la fin de sa durée.",
  "effect_rounds": "10*level",
  "effectTags": [
    "protection:plan_negatif",
    "resistance:drain_energie",
    "anti:mort_vivant"
  ],
  "modes": [
    {
      "id": "normal",
      "label": "Protection contre le Plan Négatif"
    }
  ]
};
