// ADD2E — onUse Magicien : Séparation des eaux
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 6,
  "kind": "terrain",
  "description": "Séparation des eaux modifie une zone, un terrain, une matière, un mur, une porte ou un environnement. Les dimensions et conséquences exactes sont fixées par le MD.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
