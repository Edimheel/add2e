// ADD2E — onUse Clerc niveau 2 : Immobilisation des Personnes
...
const ADD2E_SORT_CONFIG = {
  "name": "Immobilisation des Personnes",
  "slug": "immobilisation_des_personnes",
  "script_type": "hold_person",
  "description": "Ce sort immobilise sur place une à trois personnes ou créatures humanoïdes. La durée est de 4 rounds + 1 round par niveau du clerc. Si trois cibles sont visées, chacune effectue un jet de protection normal ; si deux cibles sont visées, chacune subit –1 à son jet ; si une seule cible est visée, elle subit –2. Les victimes réussissant leur jet ne ressentent aucun effet. Le sort affecte les humanoïdes usuels, notamment humains, demi-humains, gobelinoïdes, gnolls, hommes-lézards, kobolds, orques, nains, elfes, petites-gens, lutins, pixies, troglodytes et créatures similaires.",
  "effect_rounds": "2*level",
  "effectTags": [
    "etat:paralysie",
    "etat:immobilisation",
  ...
  "modes": [
    {
      "id": "normal",
      "label": "Immobilisation des Personnes"
    }
  ]
};
