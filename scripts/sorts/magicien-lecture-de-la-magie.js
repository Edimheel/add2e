// ADD2E — onUse Magicien : Lecture de la magie
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "lecture_de_la_magie",
  "level": 1,
  "kind": "detection",
  "description": "Lecture de la magie donne au magicien une perception, une lecture ou une information magique. Les protections, obstacles et limites exactes restent à résoudre selon la règle du sort.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Lecture de la magie"
    }
  ]
};
