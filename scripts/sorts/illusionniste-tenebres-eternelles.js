// ADD2E — onUse Illusionniste niveau 3 : Ténèbres éternelles
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "tenebres_eternelles",
  "level": 3,
  "classe": "Illusionniste",
  "script_type": "simple_effect",
  "description": "Ténèbres éternelles modifie une zone, un mur, un brouillard, un terrain, une lumière ou un environnement. Le script crée un suivi exploitable ; les dimensions exactes et conséquences sont gérées par le MD.",
  "effect_rounds": 0,
  "effectTags": [
    "tenebres:eternelles",
    "permanent"
