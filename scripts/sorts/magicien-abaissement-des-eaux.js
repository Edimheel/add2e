// ADD2E — onUse Magicien : Abaissement des eaux
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 6,
  "kind": "terrain",
  "description": "Abaissement des eaux modifie une zone, un terrain, une matière, un mur, une porte ou un environnement. Les dimensions et conséquences exactes sont fixées par le MD.",
  "dice": null,
  "modes": [
    {
      "id": "abaissement",
