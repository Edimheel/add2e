// ADD2E — onUse Illusionniste niveau 4 : Invisibilité améliorée
...
const ADD2E_SORT_CONFIG = {
  "name": "Invisibilité améliorée",
  "slug": "invisibilite_amelioree",
  "level": 4,
  "classe": "Illusionniste",
  "script_type": "simple_effect",
  "description": "Invisibilité améliorée applique un état mental, sensoriel ou magique : confusion, peur, cécité, surdité, paralysie, invisibilité, suggestion ou trouble. Le script crée un effet actif de suivi sur la cible.",
  "effect_rounds": "4+level",
  "effectTags": [
    "etat:invisible",
    "invisibilite:amelioree"
  ],
  "modes": [
    {
      "id": "normal",
      "label": "Invisibilité améliorée"
    }
  ],
  "dice": null
};
