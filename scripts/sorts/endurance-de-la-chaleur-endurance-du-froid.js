...
const ADD2E_CLERIC_ONUSE_CONFIG = {
  ...
  "rule": "Protège une créature contre les températures extrêmes naturelles et réduit les effets de froid ou chaleur magiques selon la version choisie.",
  "name": "Endurance de la Chaleur/Endurance du Froid",
  "slug": "endurance-de-la-chaleur-endurance-du-froid",
  "imgFallback": "systems/add2e/assets/icones/sorts/endurance-de-la-chaleur-endurance-du-froid.webp"
};
...
if (__add2eOnUseResult !== true && __add2eOnUseResult !== false) {
  console.error("[ADD2E][ONUSE][BAD_RETURN_STRICT] Le script onUse doit retourner true ou false.", {
    script: "endurance-de-la-chaleur-endurance-du-froid.js",
