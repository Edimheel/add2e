// ADD2E — onUse Druide niveau 7 : Réincarnation
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 7,
  "classe": "Druide",
  "script_type": "reincarnation",
  "description": "Réincarnation restaure la vitalité d’une créature vivante. Le soin ne dépasse pas le maximum normal de points de vie, sauf règle contraire. Le sort n’affecte normalement pas les morts-vivants ni les créatures incapables de recevoir des soins vitaux.",
  "effect_rounds": 0,
  "effectTags": [
    "reincarnation",
    "retour:vie"
