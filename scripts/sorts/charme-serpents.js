...
const ADD2E_SORT_CONFIG = {
  ...
  "script_type": "snake_charm",
  "description": "Le clerc exerce une force hypnotique sur un ou plusieurs serpents ou créatures ophidiennes assimilées. Les serpents charmés se dressent et ondulent lentement, sans attaquer. La durée dépend de leur état : 3 à 6 tours s’ils étaient en torpeur, 1 à 3 tours s’ils étaient éveillés mais calmes, ou 5 à 8 rounds s’ils étaient agressifs ou affamés. Le total des points de vie des serpents affectés ne peut pas dépasser les points de vie du clerc. Les créatures assimilées aux serpents peuvent être concernées, mais la résistance à la magie et les jets de protection restent applicables.",
  "effect_rounds": 0,
  "effectTags": [
    "charme:serpents",
    "creature:serpent",
