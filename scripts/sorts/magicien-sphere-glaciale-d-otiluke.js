// ADD2E — onUse Magicien : Sphère glaciale d’Otiluke
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "sphere_glaciale_d_otiluke",
  "level": 6,
  "kind": "damage",
  "description": "Sphère glaciale d’Otiluke produit un effet offensif de magicien. Les dégâts, jets de sauvegarde, résistances, immunités et effets secondaires doivent être appliqués selon la règle du sort et l’arbitrage du MD.",
  "dice": "special",
  "modes": [
    {
      "id": "normal",
      "label": "Sphère glaciale d’Otiluke"
    }
  ]
};
