// ADD2E — onUse Clerc niveau 4 : Bâtons en Serpents
...
const ADD2E_SORT_CONFIG = {
  "name": "Bâtons en Serpents",
  "slug": "batons_en_serpents",
  "script_type": "sticks_to_snakes",
  "description": "Le clerc transforme un ou plusieurs bâtons, branches ou objets de bois comparables en serpents vivants qui obéissent à ses ordres simples. Certains peuvent être venimeux selon le niveau et l’arbitrage du MD. La forme inverse transforme des serpents en bâtons inertes pendant la durée ou selon les conditions fixées par le MD.",
  "effect_rounds": "2*level",
  "effectTags": [
    "transmutation:baton_serpent",
    "conjuration:serpents"
  ],
  "modes": [
    {
      "id": "normal",
      "label": "Bâtons en Serpents"
    },
    {
      "id": "inverse",
      "label": "Serpents en Bâtons"
    }
  ]
};
