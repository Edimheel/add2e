// ADD2E — onUse Magicien : Verrou magique
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 2,
  "kind": "protection",
  "description": "Verrou magique applique une défense, une barrière ou une protection magique. Le script crée un effet actif de suivi afin que le sort soit visible et exploitable dans Foundry.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Verrou magique"
    }
  ]
};
