// ADD2E — onUse Clerc niveaux 5-7 : Quête religieuse
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 5,
  "script_type": "quest",
  "description": "Quête religieuse impose, retire ou transforme un état important. Le script crée un effet actif, note la contrainte ou retire les états reconnus lorsque c’est possible. Les cas ambigus restent à valider par le MD.",
  "effect_rounds": 0,
  "effectTags": [
    "quete:religieuse",
    "contrainte:divine"
