// ADD2E — onUse Druide niveau 7 : Transmutation du métal en bois
...
const ADD2E_SORT_CONFIG = {
  "name": "Transmutation du métal en bois",
  "slug": "transmutation_du_metal_en_bois",
  "level": 7,
  "classe": "Druide",
  "script_type": "note",
  "description": "Transmutation du métal en bois modifie le terrain, les plantes, les eaux, la pierre, le bois, le métal ou la météo. L’effet est principalement tactique et scénographique : le MD fixe les dimensions exactes, la praticabilité, les dégâts éventuels et les conséquences durables.",
  "effect_rounds": 0,
  "effectTags": [
    "transmutation:metal_bois"
  ],
  "modes": [
    {
      "id": "normal",
      "label": "Transmutation du métal en bois"
    }
  ],
  "dice": null
};
