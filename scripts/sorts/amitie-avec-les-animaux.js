...
const ADD2E_CLERIC_ONUSE_CONFIG = {
  ...
  "durationRounds": 0,
  "touch": false,
  "effectName": "Amitié animale",
  "summary": "Cible un animal normal. Le MJ valide que les intentions sont réellement amicales.",
  "tags": [
  ...
  "rule": "Permet au clerc de gagner la confiance d’un animal normal si ses intentions sont réellement amicales. L’animal devient calme et peut suivre le clerc tant qu’il est bien traité.",
  "name": "Amitié avec les Animaux",
  "slug": "amitie-avec-les-animaux",
  "imgFallback": "systems/add2e/assets/icones/sorts/amitie-avec-les-animaux.webp"
};
...
if (__add2eOnUseResult !== true && __add2eOnUseResult !== false) {
  console.error("[ADD2E][ONUSE][BAD_RETURN_STRICT] Le script onUse doit retourner true ou false.", {
    script: "amitie-avec-les-animaux.js",
