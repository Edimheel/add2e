// ADD2E — onUse Clerc niveau 3 : Appel de la Foudre
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "appel_de_la_foudre",
  "script_type": "call_lightning",
  "description": "Le clerc appelle les éclairs d’un ciel déjà chargé d’orage. Pendant la durée, il peut faire tomber des traits de foudre sur des points visibles dans la zone permise ; chaque trait inflige des dégâts électriques, avec jet de protection pour moitié. Le sort exige des conditions météorologiques adaptées et ne fonctionne pas dans un lieu fermé sans ciel ouvert.",
