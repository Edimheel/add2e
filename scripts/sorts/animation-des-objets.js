// ADD2E — onUse Clerc niveaux 5-7 : Animation des objets
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "animation_des_objets",
  "level": 6,
  "script_type": "animate_object",
  "description": "Animation des objets impose, retire ou transforme un état important. Le script crée un effet actif, note la contrainte ou retire les états reconnus lorsque c’est possible. Les cas ambigus restent à valider par le MD.",
  "effect_rounds": "level",
  "effectTags": [
    "animation:objet",
    "objet:anime"
