// ADD2E — onUse Magicien : Tempête de glace
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "tempete_de_glace",
  "level": 4,
  "kind": "damage",
  "description": "Tempête de glace produit un effet offensif de magicien. Les dégâts, jets de sauvegarde, résistances, immunités et effets secondaires doivent être appliqués selon la règle du sort et l’arbitrage du MD.",
  "dice": "3d10",
  "modes": [
    {
      "id": "normal",
      "label": "Tempête de glace"
    }
  ]
};
