// ADD2E — onUse Magicien : Protection d’esprit
// Version : 2026-05-05-magicien-n1-9-v2
// Retour attendu : true = sort consommé, false = sort non consommé.

const ADD2E_SORT_CONFIG = {
  "name": "Protection d’esprit",
  "slug": "protection_d_esprit",
  "level": 8,
  "kind": "protection",
  "description": "Protection d’esprit applique une défense, une barrière ou une protection magique. Le script crée un effet actif de suivi afin que le sort soit visible et exploitable dans Foundry.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Protection d’esprit"
    }
  ]
};
