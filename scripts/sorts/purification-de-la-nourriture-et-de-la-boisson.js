...
const ADD2E_CLERIC_ONUSE_CONFIG = {
  "kind": "declaration",
  "createEffect": false,
  "targetLabel": "Nourriture / boisson",
  "modes": [
    {
      "key": "purification",
      "label": "Purification",
  ...
  "fields": [
    {
      "name": "quantite",
      "label": "Quantité ou contenant concerné",
      "type": "text",
      "value": "27 dm³/niveau maximum"
    }
  ],
  "tags": [
    "sort:purification_nourriture_boisson",
    "purification:nourriture",
    "purification:boisson",
    "anti:poison",
    "anti:souillure"
  ],
  "resultText": "La nourriture ou boisson concernée est traitée. Le MJ valide le volume exact et les conséquences de l’inverse.",
  "rule": "Purifie nourriture et boisson souillées, pourries, empoisonnées ou impropres. Inverse : corruption de la nourriture et de la boisson.",
  "name": "Purification de la Nourriture et de la Boisson",
  "slug": "purification-de-la-nourriture-et-de-la-boisson",
  "imgFallback": "systems/add2e/assets/icones/sorts/purification-de-la-nourriture-et-de-la-boisson.webp"
};
...
if (__add2eOnUseResult !== true && __add2eOnUseResult !== false) {
  console.error("[ADD2E][ONUSE][BAD_RETURN_STRICT] Le script onUse doit retourner true ou false.", {
    script: "purification-de-la-nourriture-et-de-la-boisson.js",
