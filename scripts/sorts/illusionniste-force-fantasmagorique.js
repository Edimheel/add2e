// ADD2E — onUse Illusionniste niveau 1 : Force fantasmagorique
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "force_fantasmagorique",
  "level": 1,
  "classe": "Illusionniste",
  "script_type": "note",
  "description": "Force fantasmagorique crée, modifie ou maintient une illusion. La perception des créatures, les interactions physiques, les sauvegardes éventuelles et les limites de vraisemblance sont déterminées par les règles du sort et par le MD.",
  "effect_rounds": 0,
  "effectTags": [
    "illusion:force_fantasmagorique"
  ],
  "modes": [
    {
      "id": "normal",
      "label": "Force fantasmagorique"
    }
  ],
  "dice": null
};
