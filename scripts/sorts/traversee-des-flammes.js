// ADD2E — onUse Clerc niveau 3 : Traversée des Flammes
...
const ADD2E_SORT_CONFIG = {
  "name": "Traversée des Flammes",
  "slug": "traversee_des_flammes",
  "script_type": "target_effect",
  "description": "Permet à une créature de traverser des flammes naturelles ou magiques avec une protection renforcée contre la chaleur. Le sort ne rend pas invulnérable à tous les dégâts de feu, mais réduit les risques et permet de franchir des barrières de flammes selon les règles.",
  "effect_rounds": "level",
  "effectTags": [
    "resistance:feu",
    "deplacement:flammes",
    "etat:traversee_flammes"
  ],
  "modes": [
    {
      "id": "normal",
      "label": "Traversée des Flammes"
    }
  ]
};
