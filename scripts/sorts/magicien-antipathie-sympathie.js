// ADD2E — onUse Magicien : Antipathie/sympathie
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "antipathie_sympathie",
  "level": 8,
  "kind": "utility",
  "description": "Antipathie/sympathie produit un effet utilitaire de magicien. Le script conserve la structure ADD2E, affiche un message de chat et crée un suivi si nécessaire.",
  "dice": null,
  "modes": [
    {
      "id": "antipathie",
