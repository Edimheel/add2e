// ADD2E — onUse Illusionniste niveau 2 : Force fantasmagorique améliorée
...
const ADD2E_SORT_CONFIG = {
  "name": "Force fantasmagorique améliorée",
  "slug": "force_fantasmagorique_amelioree",
  "level": 2,
  "classe": "Illusionniste",
  "script_type": "note",
  "description": "Force fantasmagorique améliorée crée, modifie ou maintient une illusion. La perception des créatures, les interactions physiques, les sauvegardes éventuelles et les limites de vraisemblance sont déterminées par les règles du sort et par le MD.",
  "effect_rounds": 0,
  "effectTags": [
    "illusion:force_fantasmagorique_amelioree"
  ],
  "modes": [
    {
      "id": "normal",
      "label": "Force fantasmagorique améliorée"
    }
  ],
  "dice": null
};
