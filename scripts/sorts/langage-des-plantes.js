// ADD2E — onUse Clerc niveau 4 : Langage des Plantes
...
const ADD2E_SORT_CONFIG = {
  "name": "Langage des Plantes",
  "slug": "langage_des_plantes",
  "script_type": "communication_note",
  "description": "Le clerc peut communiquer avec les plantes, y compris les végétaux ordinaires et certaines créatures végétales. Les plantes peuvent transmettre des impressions simples : passage de créatures, perturbations, lumière, eau, feu ou danger. Elles ne deviennent pas forcément intelligentes et leurs réponses restent limitées à leur perception.",
  "effect_rounds": "level",
  "effectTags": [
