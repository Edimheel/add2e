// ADD2E — onUse Magicien : Boule de feu à retardement
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "boule_de_feu_a_retardement",
  "level": 7,
  "kind": "damage",
  "description": "Boule de feu à retardement produit un effet offensif de magicien. Les dégâts, jets de sauvegarde, résistances, immunités et effets secondaires doivent être appliqués selon la règle du sort et l’arbitrage du MD.",
  "dice": "leveld6",
  "modes": [
    {
      "id": "normal",
      "label": "Boule de feu à retardement"
    }
  ]
};
