// ADD2E — onUse Magicien : Mur de glace
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 4,
  "kind": "terrain",
  "description": "Mur de glace modifie une zone, un terrain, une matière, un mur, une porte ou un environnement. Les dimensions et conséquences exactes sont fixées par le MD.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
