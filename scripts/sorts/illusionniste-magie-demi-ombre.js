// ADD2E — onUse Illusionniste niveau 6 : Magie demi-ombre
...
const ADD2E_SORT_CONFIG = {
  "name": "Magie demi-ombre",
  "slug": "magie_demi_ombre",
  "level": 6,
  "classe": "Illusionniste",
  "script_type": "mode_note",
  "description": "Magie demi-ombre crée, modifie ou maintient une illusion. La perception des créatures, les interactions physiques, les sauvegardes éventuelles et les limites de vraisemblance sont déterminées par les règles du sort et par le MD.",
  "effect_rounds": 0,
  "effectTags": [
    "magie:demi_ombre"
  ],
  "modes": [
    {
      "id": "evocation",
      "label": "Évocation demi-ombre"
    },
    {
      "id": "conjuration",
      "label": "Conjuration demi-ombre"
    }
  ],
  "dice": null
};
