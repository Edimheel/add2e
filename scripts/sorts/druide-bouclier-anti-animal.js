// ADD2E — onUse Druide niveau 6 : Bouclier anti-animal
...
const ADD2E_SORT_CONFIG = {
  "name": "Bouclier anti-animal",
  "slug": "bouclier_anti_animal",
  "level": 6,
  "classe": "Druide",
  "script_type": "simple_effect",
  "description": "Bouclier anti-animal place une protection naturelle ou druidique sur une créature, une zone ou le lanceur. L’effet doit être pris en compte lors des attaques, jets de sauvegarde, déplacements ou interactions avec les créatures et éléments concernés. Les limites exactes dépendent de la scène et de la règle du sort.",
  "effect_rounds": "10*level",
  "effectTags": [
    "bouclier:anti_animaux",
    "protection:animaux"
  ],
  "modes": [
    {
      "id": "normal",
      "label": "Bouclier anti-animal"
    }
  ],
  "dice": null
};
