// ADD2E — onUse Magicien : Poigne de Bigby
// Version : 2026-05-05-magicien-n1-9-v2
// Retour attendu : true = sort consommé, false = sort non consommé.

const ADD2E_SORT_CONFIG = {
  "name": "Poigne de Bigby",
  "slug": "poigne_de_bigby",
  "level": 7,
  "kind": "utility",
  "description": "Poigne de Bigby produit un effet utilitaire de magicien. Le script conserve la structure ADD2E, affiche un message de chat et crée un suivi si nécessaire.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Poigne de Bigby"
    }
  ]
};
