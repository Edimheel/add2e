...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 1,
  "kind": "damage",
  "description": "Mains brûlantes produit un effet offensif de magicien. Les dégâts, jets de sauvegarde, résistances, immunités et effets secondaires doivent être appliqués selon la règle du sort et l’arbitrage du MD.",
  "dice": "leveld3",
  "modes": [
    {
      "id": "normal",
      "label": "Mains brûlantes"
    }
  ]
};
