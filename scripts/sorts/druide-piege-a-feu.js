// ADD2E — onUse Druide niveau 2 : Piège à feu
...
const ADD2E_SORT_CONFIG = {
  ...
  "classe": "Druide",
  "script_type": "note",
  "description": "Piège à feu produit un effet offensif lié au feu, à la foudre, aux insectes, aux éléments ou à une force naturelle. Les dégâts indiqués par le script sont un support de résolution ; les sauvegardes, résistances et effets secondaires sont appliqués par le MD.",
  "effect_rounds": 0,
  "effectTags": [
    "piege:feu",
    "degat:feu"
