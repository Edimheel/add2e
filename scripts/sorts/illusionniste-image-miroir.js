// ADD2E — onUse Illusionniste niveau 2 : Image miroir
...
const ADD2E_SORT_CONFIG = {
  ...
  "description": "Image miroir applique une protection, une dissipation, un écran ou une défense magique. Le script pose un effet actif avec les tags nécessaires pour que la mécanique ADD2E puisse l’exploiter si elle existe.",
  "effect_rounds": "3*level",
  "effectTags": [
