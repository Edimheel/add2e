// ADD2E — onUse Magicien : Transmutation de pierre en boue
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 5,
  "kind": "terrain",
  "description": "Transmutation de pierre en boue modifie une zone, un terrain, une matière, un mur, une porte ou un environnement. Les dimensions et conséquences exactes sont fixées par le MD.",
  "dice": null,
  "modes": [
    {
      "id": "pierre_boue",
