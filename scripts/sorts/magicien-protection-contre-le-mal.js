// ADD2E — onUse Magicien : Protection contre le mal
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "protection_contre_le_mal",
  "level": 1,
  "kind": "protection",
  "description": "Protection contre le mal applique une défense, une barrière ou une protection magique. Le script crée un effet actif de suivi afin que le sort soit visible et exploitable dans Foundry.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
