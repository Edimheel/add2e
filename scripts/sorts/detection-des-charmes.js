// ADD2E — onUse Clerc niveau 2 : Détection des Charmes
...
const ADD2E_SORT_CONFIG = {
  "name": "Détection des Charmes",
  "slug": "detection_des_charmes",
  "script_type": "detect_charm",
  "description": "Ce sort permet au clerc de déterminer si une personne ou un monstre est sous l’influence d’un charme. Jusqu’à dix créatures peuvent être examinées avant la fin du sort. La forme inversée, dissimulation des charmes, protège une seule créature contre cette détection et peut empêcher le clerc ou d’autres lanceurs de discerner l’enchantement actif. Un jet de protection peut annuler la détection selon la cible et les conditions.",
  "effect_rounds": 10,
  "effectTags": [
    "detection:charme",
  ...
  "inverseLabel": "Dissimulation des Charmes",
  "inverseTags": [
    "reversible:dissimulation_des_charmes",
    "etat:dissimulation_des_charmes"
  ]
};
