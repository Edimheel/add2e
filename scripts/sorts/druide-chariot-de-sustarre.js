// ADD2E — onUse Druide niveau 7 : Chariot de Sustarre
...
const ADD2E_SORT_CONFIG = {
  "name": "Chariot de Sustarre",
  "slug": "chariot_de_sustarre",
  "level": 7,
  "classe": "Druide",
  "script_type": "note",
  "description": "Chariot de Sustarre facilite un déplacement naturel ou surnaturel par les plantes, les airs, l’eau, le vent ou un élément. La destination, le passage, la durée et les limites exactes dépendent de la scène et de l’arbitrage du MD.",
  "effect_rounds": 0,
  "effectTags": [
    "chariot:sustarre",
    "feu",
