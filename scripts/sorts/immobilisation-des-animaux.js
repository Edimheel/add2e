// ADD2E — onUse Clerc niveau 3 : Immobilisation des Animaux
...
const ADD2E_SORT_CONFIG = {
  "name": "Immobilisation des Animaux",
  "slug": "immobilisation_des_animaux",
  "script_type": "target_effect",
  "description": "Immobilise un ou plusieurs animaux si leur jet de protection échoue. Les créatures affectées restent conscientes mais ne peuvent pas se déplacer ni attaquer jusqu’à la fin de l’effet ou sa dissipation.",
  ...
  "modes": [
    {
      "id": "normal",
      "label": "Immobilisation des Animaux"
    }
  ]
};
