// ADD2E — onUse Clerc niveau 3 : Conjuration d’Insectes
...
const ADD2E_SORT_CONFIG = {
  "name": "Conjuration d’Insectes",
  "slug": "conjuration_d_insectes",
  "script_type": "swarm_effect",
  "description": "Conjure une nuée d’insectes qui harcèle les créatures désignées. La nuée gêne la concentration, les actions précises et peut infliger de petites blessures selon le contexte. Elle se disperse si elle est dissipée, repoussée par des moyens adaptés ou si le clerc perd le contrôle imposé par le sort.",
  "effect_rounds": "level",
  "effectTags": [
    "conjuration:insectes",
    "etat:gene",
    "concentration:genee"
  ],
  "modes": [
