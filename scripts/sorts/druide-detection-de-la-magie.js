// ADD2E — onUse Druide niveau 1 : Détection de la magie
...
const ADD2E_SORT_CONFIG = {
  ...
  "description": "Détection de la magie permet au druide d’obtenir une perception surnaturelle liée à la nature, à la magie, aux créatures ou au danger recherché. La portée, l’orientation, les obstacles, les protections magiques et la précision de la recherche sont toujours pris en compte par le MD.",
  "effect_rounds": "10",
  "effectTags": [
    "detection:magie"
  ],
