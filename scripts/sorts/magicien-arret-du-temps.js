// ADD2E — onUse Magicien : Arrêt du temps
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 9,
  "kind": "utility",
  "description": "Arrêt du temps produit un effet utilitaire de magicien. Le script conserve la structure ADD2E, affiche un message de chat et crée un suivi si nécessaire.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Arrêt du temps"
    }
  ]
};
