// ADD2E — onUse Clerc niveau 2 : Charmes-Personne ou Mammifère
...
const ADD2E_SORT_CONFIG = {
  "name": "Charmes-Personne ou Mammifère",
  "slug": "charmes_personne_ou_mammifere",
  "script_type": "target_effect",
  "description": "Ce sort charme une personne ou un mammifère si la cible rate son jet de protection contre les sorts. La cible considère alors le clerc comme un ami de confiance et interprète favorablement ses paroles et ses demandes, dans les limites de son intelligence, de sa nature et de son instinct de conservation. Le sort ne donne pas un contrôle absolu : les ordres suicidaires, clairement nuisibles ou contraires à la nature profonde de la créature peuvent être refusés ou provoquer un nouveau jet selon l’arbitrage du MD. La durée dépend des règles de charme et des sauvegardes périodiques applicables.",
  "effect_rounds": 0,
  "effectTags": [
    "charme",
    "mental",
  ...
  "modes": [
    {
      "id": "normal",
      "label": "Charmes-Personne ou Mammifère"
    }
  ]
};
