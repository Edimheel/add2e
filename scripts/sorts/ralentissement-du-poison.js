// ADD2E — onUse Clerc niveau 2 : Ralentissement du Poison
...
const ADD2E_SORT_CONFIG = {
  "name": "Ralentissement du Poison",
  "slug": "ralentissement_du_poison",
  "script_type": "slow_poison",
  "description": "Le clerc touche une créature empoisonnée et ralentit considérablement la progression du poison. Le sort ne neutralise pas nécessairement le poison et ne répare pas les dégâts déjà subis ; il retarde ses effets pendant 1 heure par niveau du clerc, donnant le temps de recevoir un contre-poison, des soins ou une autre intervention. Si la durée expire sans traitement définitif, le poison peut reprendre son cours selon l’état de la victime et la décision du MD.",
  "effect_rounds": "60*level",
  "effectTags": [
    "poison:ralenti",
    "protection:poison",
    "etat:ralentissement_poison"
  ],
  "modes": [
    {
      "id": "normal",
      "label": "Ralentissement du Poison"
    }
  ]
};
