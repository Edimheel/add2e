...
const ADD2E_SORT_CONFIG = {
  ...
  "script_type": "spiritual_hammer",
  "description": "Le clerc invoque une force divine ayant la forme vague d’un marteau. Tant qu’il se concentre et que la durée n’est pas écoulée, ce marteau frappe un ennemi situé à portée. Il peut toucher les créatures normalement vulnérables seulement aux armes magiques : il est considéré comme magique avec +1 par tranche de trois niveaux du clerc pour cette condition, mais ce bonus ne s’ajoute ni au jet d’attaque ni aux dégâts. Le marteau inflige 1d6 contre les créatures de taille petite ou moyenne et 1d4 contre les grandes. Il attaque comme si le clerc le maniait lui-même et disparaît si la concentration cesse.",
  "effect_rounds": "level",
  "effectTags": [
    "arme:marteau_spirituel",
    "degat:force",
    "attaque:magique",
    "concentration"
  ],
