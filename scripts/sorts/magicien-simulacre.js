// ADD2E — onUse Magicien : Simulacre
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 7,
  "kind": "summon",
  "description": "Simulacre invoque, appelle ou crée une créature, un serviteur ou une force magique. Le script note l’invocation ; l’acteur correspondant doit être créé ou lié par le MD.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
