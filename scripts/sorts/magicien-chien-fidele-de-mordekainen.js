// ADD2E — onUse Magicien : Chien fidèle de Mordekainen
// Version : 2026-05-05-magicien-n1-9-v2
// Retour attendu : true = sort consommé, false = sort non consommé.

const ADD2E_SORT_CONFIG = {
  "name": "Chien fidèle de Mordekainen",
  "slug": "chien_fidele_de_mordekainen",
  "level": 5,
  "kind": "utility",
  "description": "Chien fidèle de Mordekainen produit un effet utilitaire de magicien. Le script conserve la structure ADD2E, affiche un message de chat et crée un suivi si nécessaire.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
      "label": "Chien fidèle de Mordekainen"
    }
  ]
};
