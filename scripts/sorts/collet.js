// ADD2E — onUse Clerc niveau 3 : Collet
...
const ADD2E_SORT_CONFIG = {
  "name": "Collet",
  "slug": "collet",
  "script_type": "ward_note",
  "description": "Transforme une corde, une liane ou un matériau semblable en piège magique. Une créature qui déclenche le collet peut être entravée, soulevée ou retenue selon la préparation. Le MD détermine l’emplacement exact, la dissimulation et les effets pratiques selon la scène.",
  "effect_rounds": 0,
  "effectTags": [
    "piege:collet",
    "etat:entrave",
