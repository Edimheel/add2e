// ADD2E — onUse Magicien : Bouclier de feu
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "bouclier_de_feu",
  "level": 4,
  "kind": "protection",
  "description": "Bouclier de feu applique une défense, une barrière ou une protection magique. Le script crée un effet actif de suivi afin que le sort soit visible et exploitable dans Foundry.",
  "dice": null,
  "modes": [
    {
      "id": "normal",
