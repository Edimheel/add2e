// ADD2E — onUse Clerc niveau 3 : Guérison des Maladies
...
const ADD2E_SORT_CONFIG = {
  ...
  "slug": "guerison_des_maladies",
  "script_type": "cure_conditions",
  "description": "Guérit une maladie affectant la créature touchée, y compris certaines affections parasitaires ou surnaturelles si le MD les considère comme des maladies. Le sort ne rend pas automatiquement les points de vie déjà perdus, mais arrête la progression de l’affection.",
  "effect_rounds": 0,
  "effectTags": [
    "retire:maladie",
    "soin:maladie"
