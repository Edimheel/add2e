// ADD2E — onUse Illusionniste niveau 4 : Émotion
...
const ADD2E_SORT_CONFIG = {
  ...
  "description": "Émotion applique un état mental, sensoriel ou magique : confusion, peur, cécité, surdité, paralysie, invisibilité, suggestion ou trouble. Le script crée un effet actif de suivi sur la cible.",
  "effect_rounds": 0,
  "effectTags": [
    "emotion",
    "mental"
