// ADD2E — onUse Clerc niveaux 5-7 : Symbole
...
const ADD2E_SORT_CONFIG = {
  ...
  "level": 7,
  "script_type": "symbol",
  "description": "Symbole applique une protection ou une dissipation divine. L’effet est noté par un effet actif et doit être pris en compte lors des jets de sauvegarde, attaques, influences magiques ou interactions avec les créatures concernées.",
  "effect_rounds": 0,
  "effectTags": [
    "symbole",
    "glyphe",
