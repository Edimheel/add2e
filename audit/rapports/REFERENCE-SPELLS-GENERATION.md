...
24 objets matériels conservent `consommation: "a_verifier"`, sur 13 sorts :
...
33 objets structurés sans consommation incertaine.

## Composants magicien encore à vérifier

79 objets conservent `consommation: "a_verifier"`.
...
55 objets structurés sans consommation incertaine.

## Composants magicien encore à vérifier

63 objets conservent `consommation: "a_verifier"`.
...
65 objets structurés sans consommation incertaine.

## Composants magicien encore à vérifier

55 objets conservent `consommation: "a_verifier"`.
...
7 objets structurés sans consommation incertaine.

## Composants illusionniste encore à vérifier

3 objets conservent `consommation: "a_verifier"`.
