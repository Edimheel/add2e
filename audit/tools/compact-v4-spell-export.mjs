...
const PROFILE_OVERRIDES = Object.freeze({
  ...
  changement_dapparence: { mechanic: "utility", operation: "disguise_self" },
  ...
  contact_dautres_plans: { mechanic: "divination", operation: "contact_other_plane" },
  danse_irresistible_dotto: { mechanic: "status", operation: "irresistible_dance", status: ["dancing", "incapacitated"] },
  detection_de_linvisibilite: { mechanic: "detection", operation: "invisibility" },
  dissipation_de_lepuisement: { mechanic: "status", operation: "remove_exhaustion" },
  ...
  emprisonnement_de_lame: { mechanic: "status", operation: "soul_trap", status: ["imprisoned"] },
  enchevetrement: { mechanic: "status", operation: "entangle", status: ["restrained", "entangled"] },
  escalade_daraignee: { mechanic: "movement", operation: "spider_climb" },
  flamme: { mechanic: "damage", operation: "flame", damageType: "fire" },
  fleau_dinsectes: { mechanic: "summon", operation: "insect_plague" },
  foudre: { mechanic: "damage", operation: "lightning", damageType: "lightning" },
  globe_dinvulnerabilite: { mechanic: "protection", operation: "globe_of_invulnerability" },
  globe_mineur_dinvulnerabilite: { mechanic: "protection", operation: "minor_globe_of_invulnerability" },
  ...
  invocation_delemental: { mechanic: "summon", operation: "elemental_summoning" },
  invocation_dinsectes: { mechanic: "summon", operation: "insect_summoning" },
  invocation_dun_elemental_de_terre: { mechanic: "summon", operation: "earth_elemental" },
  invocation_dun_elemental_du_feu: { mechanic: "summon", operation: "fire_elemental" },
  invocation_dun_familier: { mechanic: "summon", operation: "find_familiar" },
  ...
  main_dinterposition_de_bigby: { mechanic: "protection", operation: "bigby_interposing_hand" },
  ...
  mur_depines: { mechanic: "terrain", operation: "wall_of_thorns" },
  ...
  peau_decorce: { mechanic: "protection", operation: "barkskin" },
  ...
  protection_desprit: { mechanic: "protection", operation: "mind_protection" },
  purification_de_leau: { mechanic: "utility", operation: "purify_water" },
  purification_de_leau_et_des_aliments: { mechanic: "utility", operation: "purify_food_and_drink" },
  rayon_daffaiblissement: { mechanic: "status", operation: "ray_of_enfeeblement", status: ["weakened"] },
  ...
  sphere_glaciale_dotiluke: { mechanic: "damage", operation: "freezing_sphere", damageType: "cold" },
  toile_daraignee: { mechanic: "terrain", operation: "web" },
  transformation_dobjets: { mechanic: "utility", operation: "polymorph_any_object" }
});
